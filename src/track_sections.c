...
#define STEEP_TO_VERTICAL_DIAG_LENGTH (1*TILE_SIZE)
#define VERTICAL_TO_STEEP_DIAG_LENGTH (1*TILE_SIZE)
...
{
return cubic_curve_vertical_old(0,0,TILE_SIZE,0,0,-CLEARANCE_HEIGHT,2*CLEARANCE_HEIGHT,0,0,0,0,0,0,0,1,distance);
}
...
{
return cubic_curve_vertical_old(-0.5*TILE_SIZE,TILE_SIZE,0.5*TILE_SIZE,0,CLEARANCE_HEIGHT,2*CLEARANCE_HEIGHT,CLEARANCE_HEIGHT,0,1.03809332e-04,-2.00628254e-03,1.59305808e-02,-6.75327840e-02,1.68115244e-01,-2.67819389e-01,4.74022260e-01,distance);
}
track_point_t steep_to_gentle_up_curve(float distance)
{
return cubic_curve_vertical_old(-0.5*TILE_SIZE,0.5*TILE_SIZE,TILE_SIZE,0,CLEARANCE_HEIGHT,-5*CLEARANCE_HEIGHT,8*CLEARANCE_HEIGHT,0,1.03809332e-04,-1.50249574e-03,8.63282156e-03,-2.44630312e-02,3.57654761e-02,-1.76496309e-02,1.47759227e-01,distance);
}
...
{
return cubic_curve_vertical_old(-TILE_SIZE/6,-TILE_SIZE/6,5*TILE_SIZE/6,-TILE_SIZE/2,2*CLEARANCE_HEIGHT/3,-CLEARANCE_HEIGHT/3,20*CLEARANCE_HEIGHT/3,0,-1.27409679e-07,1.66746015e-06,-6.60784097e-06,2.87367949e-06,5.24290249e-04,-1.54572818e-03,1.70550125e-01,distance);
}
track_point_t vertical_to_steep_up_curve(float distance)
{
return cubic_curve_vertical_old(-TILE_SIZE/6,2*TILE_SIZE/3,0,0,-2*CLEARANCE_HEIGHT/3,CLEARANCE_HEIGHT,20*CLEARANCE_HEIGHT/3,0,-1.27409680e-07,3.35138224e-06,-3.50358430e-05,1.85655626e-04,-3.24817476e-05,-6.05934285e-03,2.00014155e-01,distance);
}
...
{
return cubic_curve_horizontal(68*CLEARANCE_HEIGHT/3-5*TILE_SIZE,7.5*TILE_SIZE-112*CLEARANCE_HEIGHT/3,44*CLEARANCE_HEIGHT/3,0,8*CLEARANCE_HEIGHT-2*TILE_SIZE,3*TILE_SIZE-8*CLEARANCE_HEIGHT,0,0,4.13551374e-09,-6.73303292e-08,5.27398800e-07,4.75914480e-06,-4.03664043e-06,4.03835068e-04,1.01222332e-01,distance);
}
track_point_t large_turn_right_to_diag_curve(float distance)
{
return cubic_curve_horizontal(68*CLEARANCE_HEIGHT/3-5*TILE_SIZE,7.5*TILE_SIZE-112*CLEARANCE_HEIGHT/3,44*CLEARANCE_HEIGHT/3,0,2*TILE_SIZE-8*CLEARANCE_HEIGHT,8*CLEARANCE_HEIGHT-3*TILE_SIZE,0,0,4.13551374e-09,-6.73303292e-08,5.27398800e-07,4.75914480e-06,-4.03664043e-06,4.03835068e-04,1.01222332e-01,distance);
}
...
{
return cubic_curve_horizontal(152*CLEARANCE_HEIGHT/3-6*TILE_SIZE,9*TILE_SIZE-76*CLEARANCE_HEIGHT,76*CLEARANCE_HEIGHT/3,0,-TILE_SIZE*2,3*TILE_SIZE,0,0,-3.83794701e-07,1.43656901e-05,-1.92240010e-04,1.03219045e-03,-1.92626934e-03,6.80531878e-03,5.77160750e-02,distance);
}
...
track_point_t half_loop_curve(float distance)
{
	...
	else if(distance<HALF_LOOP_SEGMENT2_LENGTH)return cubic_curve_vertical_old(3*TILE_SIZE-32*CLEARANCE_HEIGHT/3,16*CLEARANCE_HEIGHT-6.5*TILE_SIZE,4*TILE_SIZE,0.5*TILE_SIZE,-14*CLEARANCE_HEIGHT/3,19*CLEARANCE_HEIGHT/3,8*CLEARANCE_HEIGHT,CLEARANCE_HEIGHT,2.60735963e-07,-7.42305927e-06,8.47657813e-05,-4.81686166e-04,1.50741670e-03,3.64826748e-04,6.3993545e-02,distance-HALF_LOOP_SEGMENT1_LENGTH);
	else return cubic_curve_vertical_old(0,-16*CLEARANCE_HEIGHT/3,0,16*CLEARANCE_HEIGHT/3+TILE_SIZE,-8*CLEARANCE_HEIGHT/3,-4*CLEARANCE_HEIGHT/3,32*CLEARANCE_HEIGHT/3,32*CLEARANCE_HEIGHT/3,4.98545231e-07,-8.90813710e-06,4.65444884e-05,-1.03595298e-04,3.16464106e-04,1.97218182e-03,1.24963548e-01,distance-HALF_LOOP_SEGMENT2_LENGTH);
}
...
float proj_distance=distance/VERTICAL_LOOP_FACTOR;
	if(proj_distance<VERTICAL_LOOP_SEGMENT1_LENGTH)point=plane_curve_vertical(vector3(0.0,CLEARANCE_HEIGHT*(proj_distance/VERTICAL_LOOP_SEGMENT1_LENGTH),0.5*TILE_SIZE*(proj_distance/VERTICAL_LOOP_SEGMENT1_LENGTH)),vector3_normalize(vector3(0.0,2*CLEARANCE_HEIGHT/TILE_SIZE,1.0)));
	else if(proj_distance<VERTICAL_LOOP_SEGMENT2_LENGTH)point=cubic_curve_vertical_old(TILE_SIZE,-3.5*TILE_SIZE,4*TILE_SIZE,0.5*TILE_SIZE,-20*CLEARANCE_HEIGHT/3,26*CLEARANCE_HEIGHT/3,8*CLEARANCE_HEIGHT,CLEARANCE_HEIGHT,2.60735963e-07,-7.42305927e-06,8.47657813e-05,-4.81686166e-04,1.50741670e-03,3.64826748e-04,6.3993545e-02,proj_distance-VERTICAL_LOOP_SEGMENT1_LENGTH);
	else point=cubic_curve_vertical(0,-TILE_SIZE,0,2*TILE_SIZE,-11*CLEARANCE_HEIGHT/3,9*CLEARANCE_HEIGHT/6,8*CLEARANCE_HEIGHT,33*CLEARANCE_HEIGHT/3,0,0,0,0,0,0,1,(proj_distance-VERTICAL_LOOP_SEGMENT2_LENGTH)/(VERTICAL_LOOP_LENGTH/VERTICAL_LOOP_FACTOR-VERTICAL_LOOP_SEGMENT2_LENGTH));
...
{
return cubic_curve_vertical_old(-0.5*TILE_SIZE,-0.5*TILE_SIZE,5*TILE_SIZE,0,-2*CLEARANCE_HEIGHT,13*CLEARANCE_HEIGHT,0,0,9.15921042e-12,-7.64176033e-10,1.91775506e-08,-6.20557903e-08,-1.07682192e-05,2.95991517e-04,5.44333126e-02,distance);
}

track_point_t steep_to_flat_up_curve(float distance)
{
return cubic_curve_vertical_old(-0.5*TILE_SIZE,2*TILE_SIZE,2.5*TILE_SIZE,0,-2*CLEARANCE_HEIGHT,-7*CLEARANCE_HEIGHT,20*CLEARANCE_HEIGHT,0,9.15921034e-12,-3.64783573e-10,-1.92055403e-09,1.77492141e-07,-8.30160814e-06,1.17635683e-04,5.68534428e-02,distance);
}

track_point_t quarter_loop_up_curve(float distance)
{
return cubic_curve_vertical_old(5*TILE_SIZE-64*CLEARANCE_HEIGHT/3,-7.5*TILE_SIZE+64*CLEARANCE_HEIGHT/3,0,0,-22*CLEARANCE_HEIGHT/3,CLEARANCE_HEIGHT/3.0,64*CLEARANCE_HEIGHT/3.0,0,7.18882561e-10,-3.95603532e-08,6.77429101e-07,-4.86060220e-06,3.29621469e-05,-1.32508457e-04,6.25520141e-02,distance);
}
...
float proj_distance=distance/MEDIUM_HALF_LOOP_FACTOR;
	...
	point.position=vector3(TILE_SIZE*distance/MEDIUM_HALF_LOOP_LENGTH,cubic(-56*CLEARANCE_HEIGHT/3.0+TILE_SIZE*3.15,28*CLEARANCE_HEIGHT-TILE_SIZE*6.3,TILE_SIZE*3.15,16*CLEARANCE_HEIGHT,u),cubic(0.65*TILE_SIZE,-2.55*TILE_SIZE,0,2.9*TILE_SIZE,u));
...
track_point_t point;
point.position=vector3_add(unbanked_curve.position,
...
return roll_curve(7*CLEARANCE_HEIGHT/6,-0.5*TILE_SIZE,-1.5*TILE_SIZE,5*TILE_SIZE,0,4*CLEARANCE_HEIGHT,-11*CLEARANCE_HEIGHT,10*CLEARANCE_HEIGHT,0,a,b,c,0,2.72452673e-06,-8.60587142e-05,1.06785619e-03,-6.53445874e-03,2.04313108e-02,-2.83005236e-02,7.09176768e-02,reparameterize(-1.70840591e-06,6.64971489e-05,-1.00667206e-03,7.50562783e-03,-2.86012281e-02,4.62022020e-02,9.61979416e-01,distance));
}
...
return roll_curve(4*CLEARANCE_HEIGHT/6,0,1.0*TILE_SIZE,3.0*TILE_SIZE,0,-8*CLEARANCE_HEIGHT,0*CLEARANCE_HEIGHT,24*CLEARANCE_HEIGHT,0,a,b,c,0,4.56294513e-11,-9.86183787e-09,3.08458335e-07,-4.08131118e-06,5.38263660e-05,-3.00786755e-04,5.27935955e-02,reparameterize(1.28813475e-09,4.41476438e-09,-1.60801085e-06,2.32101117e-05,-1.72800658e-04,3.66637278e-04,9.99343058e-01,distance));
}
...
{
return cubic_curve_vertical_old(2*CLEARANCE_HEIGHT-TILE_SIZE,2*TILE_SIZE-4*CLEARANCE_HEIGHT,2*CLEARANCE_HEIGHT,0,2*CLEARANCE_HEIGHT,1*CLEARANCE_HEIGHT,0,0,3.05114828e-04,-5.41080425e-03,3.92230576e-02,-1.50356228e-01,3.31677795e-01,-4.47145240e-01,5.86667713e-01,distance);
}
track_point_t small_steep_to_flat_up_curve(float distance)
{
return cubic_curve_vertical_old(2*CLEARANCE_HEIGHT-TILE_SIZE,TILE_SIZE-2*CLEARANCE_HEIGHT,TILE_SIZE,0,2*CLEARANCE_HEIGHT,-7*CLEARANCE_HEIGHT,8*CLEARANCE_HEIGHT,0,3.05114828e-04,-4.16244486e-03,2.24366063e-02,-5.97476791e-02,8.15009919e-02,-4.17427549e-02,1.53388477e-01,distance);
}
...
track_point_t point=cubic_curve_horizontal(68*CLEARANCE_HEIGHT/3-5*TILE_SIZE,7.5*TILE_SIZE-112*CLEARANCE_HEIGHT/3,44*CLEARANCE_HEIGHT/3,0,8*CLEARANCE_HEIGHT-2*TILE_SIZE,3*TILE_SIZE-8*CLEARANCE_HEIGHT,0,0,0,0,0,0,0,0,1,u);
...
{
float u=reparameterize(4.11041054e-09,-8.33282223e-08,7.93153372e-07,5.33689315e-07,2.91230858e-05,-3.18767423e-05,9.36918039e-02,distance);
track_point_t point=cubic_curve_horizontal(68*CLEARANCE_HEIGHT/3-5*TILE_SIZE,7.5*TILE_SIZE-112*CLEARANCE_HEIGHT/3,44*CLEARANCE_HEIGHT/3,0,2*TILE_SIZE-8*CLEARANCE_HEIGHT,8*CLEARANCE_HEIGHT-3*TILE_SIZE,0,0,0,0,0,0,0,0,1,u);
...
{
float u=reparameterize(4.11041054e-09,-8.33282223e-08,7.93153372e-07,5.33689315e-07,2.91230858e-05,-3.18767423e-05,9.36918039e-02,distance);
track_point_t point=cubic_curve_horizontal(68*CLEARANCE_HEIGHT/3-5*TILE_SIZE,7.5*TILE_SIZE-92*CLEARANCE_HEIGHT/3,8*CLEARANCE_HEIGHT,0,-24*CLEARANCE_HEIGHT/3+2*TILE_SIZE,-3*TILE_SIZE+48*CLEARANCE_HEIGHT/3,-8*CLEARANCE_HEIGHT,0,0,0,0,0,0,0,1,u);
...
24*CLEARANCE_HEIGHT/3-2*TILE_SIZE,3*TILE_SIZE-48*CLEARANCE_HEIGHT/3,8*CLEARANCE_HEIGHT,0,
-68*CLEARANCE_HEIGHT/3+5*TILE_SIZE,-7.5*TILE_SIZE+92*CLEARANCE_HEIGHT/3,-8*CLEARANCE_HEIGHT,0,0,0,0,0,0,0,1,u);
point.position.y+=6*CLEARANCE_HEIGHT*u-1.5*CLEARANCE_HEIGHT*u*(u*u-2*u+1);
point.tangent.y+=CLEARANCE_HEIGHT*(6.0-1.5*(3*u*u-4*u+1))/LARGE_TURN_LENGTH;
point.tangent=vector3_normalize(point.tangent);
point.normal=vector3_cross(point.binormal,point.tangent);
...
rect_t large_turn_left_to_diag_gentle_up_rects[]={
//First angle
{INT32_MIN,-40,0,-16},{INT32_MIN,-16,2,-15},{INT32_MIN,-15,4,-14},{INT32_MIN,-14,6,-13},{INT32_MIN,-13,8,-12},{INT32_MIN,-12,10,-11},{INT32_MIN,-11,12,-10},{INT32_MIN,-10,14,-9},{INT32_MIN,-9,16,-8},{INT32_MIN,-8,18,-7},{INT32_MIN,-7,20,-6},{INT32_MIN,-6,22,-5},{INT32_MIN,-5,24,-4},{INT32_MIN,-4,26,-3},{INT32_MIN,-3,28,-2},{INT32_MIN,-2,30,-1},{INT32_MIN,-1,32,INT32_MAX},
{32,-56,INT32_MAX,-40},{0,-40,INT32_MAX,-16},{2,-16,INT32_MAX,-15},{4,-15,INT32_MAX,-14},{6,-14,INT32_MAX,-13},{8,-13,INT32_MAX,-12},{10,-12,INT32_MAX,-11},{12,-11,INT32_MAX,-10},{14,-10,INT32_MAX,-9},{16,-9,INT32_MAX,-8},{18,-8,INT32_MAX,-7},{20,-7,INT32_MAX,-6},{22,-6,INT32_MAX,-5},{24,-5,INT32_MAX,-4},{26,-4,INT32_MAX,-3},{28,-3,INT32_MAX,-2},{30,-2,INT32_MAX,-1},{32,-1,INT32_MAX,INT32_MAX},
{INT32_MIN,INT32_MIN,0,-56},{INT32_MIN,-56,32,-40},
{0,INT32_MIN,INT32_MAX,-56},
//Second angle
...
{-32,-4,-30,-3},{-32,-3,-28,-2},{-32,-2,-26,-1},{-32,-1,-24,0},{-32,0,-22,1},{-31,1,-20,2},{-30,2,-18,3},{-29,3,-16,4},{-28,4,-14,5},{-27,5,-12,6},{-26,6,-10,7},{-25,7,-8,8},{-24,8,-6,9},{-23,9,-4,10},{-22,10,-2,11},{-21,11,0,12},{-20,12,2,13},{-19,13,2,14},{-18,14,2,15},{-17,15,2,16},{-16,16,2,INT32_MAX},
{INT32_MIN,INT32_MIN,-32,1},{INT32_MIN,1,-31,2},{INT32_MIN,2,-30,3},{INT32_MIN,3,-29,4},{INT32_MIN,4,-28,5},{INT32_MIN,5,-27,6},{INT32_MIN,6,-26,7},{INT32_MIN,7,-25,8},{INT32_MIN,8,-24,9},{INT32_MIN,9,-23,10},{INT32_MIN,10,-22,11},{INT32_MIN,11,-21,12},{INT32_MIN,12,-20,13},{INT32_MIN,13,-19,14},{INT32_MIN,14,-18,15},{INT32_MIN,15,-17,16},{INT32_MIN,16,-16,INT32_MAX},
//Fourth angle
...
{0,17,0,0,large_turn_left_to_diag_gentle_up_rects+38},{0,17,-32,0,large_turn_left_to_diag_gentle_up_rects+55},{0,1,-64,32,large_turn_left_to_diag_gentle_up_rects+72},{0,1,-96,16,large_turn_left_to_diag_gentle_up_rects+73},
{0,19,0,0,large_turn_left_to_diag_gentle_up_rects+74},{0,27,32,0,large_turn_left_to_diag_gentle_up_rects+93},{0,21,0,0,large_turn_left_to_diag_gentle_up_rects+120},{0,17,32,-16,large_turn_left_to_diag_gentle_up_rects+141},
...
const track_section_t large_turn_left_to_diag_gentle_up={TRACK_EXIT_45_DEG_LEFT|TRACK_EXTRUDE_IN_FRONT,large_turn_left_to_diag_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_left_to_diag_gentle_up_masks},{0,4,large_turn_left_to_diag_gentle_up_masks + 4},{0,4,large_turn_left_to_diag_gentle_up_masks + 8},{0,4,large_turn_left_to_diag_gentle_up_masks + 12}}};
...
{30,-4,32,-3},{28,-3,32,-2},{26,-2,32,-1},{24,-1,32,0},{22,0,32,1},{20,1,31,2},{18,2,30,3},{16,3,29,4},{14,4,28,5},{12,5,27,6},{10,6,26,7},{8,7,25,8},{6,8,24,9},{4,9,23,10},{2,10,22,11},{0,11,21,12},{-2,12,20,13},{-2,13,19,14},{-2,14,18,15},{-2,15,17,16},{-2,16,16,INT32_MAX},
{32,INT32_MIN,INT32_MAX,1},{31,1,INT32_MAX,2},{30,2,INT32_MAX,3},{29,3,INT32_MAX,4},{28,4,INT32_MAX,5},{27,5,INT32_MAX,6},{26,6,INT32_MAX,7},{25,7,INT32_MAX,8},{24,8,INT32_MAX,9},{23,9,INT32_MAX,10},{22,10,INT32_MAX,11},{21,11,INT32_MAX,12},{20,12,INT32_MAX,13},{19,13,INT32_MAX,14},{18,14,INT32_MAX,15},{17,15,INT32_MAX,16},{16,16,INT32_MAX,INT32_MAX},
//Third angle
...
{0,INT32_MIN,INT32_MAX,-56},{-32,-56,INT32_MAX,-40},
{INT32_MIN,INT32_MIN,0,-56},
};
mask_t large_turn_right_to_diag_gentle_up_masks[]={
{0,33,0,0,large_turn_right_to_diag_gentle_up_rects+0},{0,41,-32,32,large_turn_right_to_diag_gentle_up_rects+33},{0,16,-64,32,large_turn_right_to_diag_gentle_up_rects+74},{0,1,-96,48,large_turn_right_to_diag_gentle_up_rects+90},
{0,19,0,0,large_turn_right_to_diag_gentle_up_rects+91},{0,27,-32,0,large_turn_right_to_diag_gentle_up_rects+110},{0,21,0,0,large_turn_right_to_diag_gentle_up_rects+137},{0,17,-32,-16,large_turn_right_to_diag_gentle_up_rects+158},
{0,17,0,0,large_turn_right_to_diag_gentle_up_rects+175},{0,17,32,0,large_turn_right_to_diag_gentle_up_rects+192},{0,1,64,32,large_turn_right_to_diag_gentle_up_rects+209},{0,1,96,16,large_turn_right_to_diag_gentle_up_rects+210},
...
const track_section_t large_turn_right_to_diag_gentle_up={TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_45_DEG_RIGHT,large_turn_right_to_diag_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_right_to_diag_gentle_up_masks},{0,4,large_turn_right_to_diag_gentle_up_masks + 4},{0,4,large_turn_right_to_diag_gentle_up_masks + 8},{0,4,large_turn_right_to_diag_gentle_up_masks + 12}}};

rect_t large_turn_left_to_orthogonal_gentle_up_rects[]={
//First angle
{0,INT32_MIN,32,INT32_MAX},
{32,INT32_MIN,64,-32},{32,-32,65,-31},{32,-31,66,-30},{32,-30,67,-29},{32,-29,68,-28},{32,-28,69,-27},{32,-27,70,-26},{32,-26,71,-25},{32,-25,72,-24},{32,-24,73,-23},{32,-23,74,-22},{32,-22,75,-21},{32,-21,76,-20},{32,-20,77,-19},{32,-19,78,-18},{32,-18,79,-17},{32,-17,80,INT32_MAX},
{64,INT32_MIN,INT32_MAX,-32},{65,-32,INT32_MAX,-31},{66,-31,INT32_MAX,-30},{67,-30,INT32_MAX,-29},{68,-29,INT32_MAX,-28},{69,-28,INT32_MAX,-27},{70,-27,INT32_MAX,-26},{71,-26,INT32_MAX,-25},{72,-25,INT32_MAX,-24},{73,-24,INT32_MAX,-23},{74,-23,INT32_MAX,-22},{75,-22,INT32_MAX,-21},{76,-21,INT32_MAX,-20},{77,-20,INT32_MAX,-19},{78,-19,INT32_MAX,-18},{79,-18,INT32_MAX,-17},{80,-17,INT32_MAX,INT32_MAX},
//Second angle
{INT32_MIN,INT32_MIN,0,8},{INT32_MIN,8,-2,9},{INT32_MIN,9,-4,10},{INT32_MIN,10,-6,11},{INT32_MIN,11,-8,12},{INT32_MIN,12,-10,13},{INT32_MIN,13,-12,14},{INT32_MIN,14,-14,15},{INT32_MIN,15,-16,16},{INT32_MIN,16,-18,17},{INT32_MIN,17,-20,18},{INT32_MIN,18,-22,19},{INT32_MIN,19,-24,20},{INT32_MIN,20,-26,21},{INT32_MIN,21,-28,22},{INT32_MIN,22,-30,23},{INT32_MIN,23,-32,INT32_MAX},
{0,INT32_MIN,16,8},{-2,8,16,9},{-4,9,16,10},{-6,10,16,11},{-8,11,16,12},{-10,12,16,13},{-12,13,16,14},{-14,14,16,15},{-16,15,16,16},{-18,16,16,17},{-20,17,16,18},{-22,18,16,19},{-24,19,16,20},{-26,20,16,21},{-28,21,16,22},{-30,22,16,23},{-32,23,16,25},{-32,25,15,26},{-32,26,13,27},{-32,27,11,28},{-32,28,9,29},{-32,29,7,30},{-32,30,5,31},{-32,31,3,32},{-32,32,1,33},{-32,33,0,INT32_MAX},
{INT32_MIN,INT32_MIN,1,-57},{INT32_MIN,-57,0,-56},{INT32_MIN,-56,-2,-55},{INT32_MIN,-55,-4,-54},{INT32_MIN,-54,-6,-53},{INT32_MIN,-53,-8,-52},{INT32_MIN,-52,-10,-51},{INT32_MIN,-51,-12,-50},{INT32_MIN,-50,-14,-49},{INT32_MIN,-49,-16,-48},{INT32_MIN,-48,-18,-47},{INT32_MIN,-47,-20,-46},{INT32_MIN,-46,-22,-45},{INT32_MIN,-45,-24,-44},{INT32_MIN,-44,-26,-43},{INT32_MIN,-43,-28,-42},{INT32_MIN,-42,-30,-41},{INT32_MIN,-41,-31,-8},
};
mask_t large_turn_left_to_orthogonal_gentle_up_masks[]={
{0,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+0},{0,0,-32,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{0,17,-64,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{0,17,-96,48,large_turn_left_to_orthogonal_gentle_up_rects+18},
{0,17,0,0,large_turn_left_to_orthogonal_gentle_up_rects+35},{0,0,-32,-16,large_turn_left_to_orthogonal_gentle_up_rects+52},{0,26,0,-16,large_turn_left_to_orthogonal_gentle_up_rects+52},{0,10,-32,-16,large_turn_left_to_orthogonal_gentle_up_rects+78},
{0,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+88},{0,0,32,-16,large_turn_left_to_orthogonal_gentle_up_rects+89},{0,33,64,16,large_turn_left_to_orthogonal_gentle_up_rects+89},{0,33,96,16,large_turn_left_to_orthogonal_gentle_up_rects+122},
{0,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+155},{0,1,32,16,large_turn_left_to_orthogonal_gentle_up_rects+156},{0,18,0,48,large_turn_left_to_orthogonal_gentle_up_rects+157},{0,18,32,80,large_turn_left_to_orthogonal_gentle_up_rects+175},
};

const track_section_t large_turn_left_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_EXIT_45_DEG_LEFT,large_turn_left_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_left_to_orthogonal_gentle_up_masks},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 4},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 8},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 12}}};

rect_t large_turn_right_to_orthogonal_gentle_up_rects[]={
//First angle
{0,INT32_MIN,32,INT32_MAX},
{32,INT32_MIN,96,-31},{32,-31,95,-30},{32,-30,94,-29},{32,-29,93,-28},{32,-28,92,-27},{32,-27,91,-26},{32,-26,90,-25},{32,-25,89,-24},{32,-24,88,-23},{32,-23,87,-22},{32,-22,86,-21},{32,-21,85,-20},{32,-20,84,-19},{32,-19,83,-18},{32,-18,82,-17},{32,-17,81,-16},{32,-16,80,-15},{32,-15,79,-14},{32,-14,78,-13},{32,-13,77,-12},{32,-12,76,-11},{32,-11,75,-10},{32,-10,74,-9},{32,-9,73,-8},{32,-8,72,-7},{32,-7,71,-6},{32,-6,70,-5},{32,-5,69,-4},{32,-4,68,-3},{32,-3,67,-2},{32,-2,66,-1},{32,-1,65,0},{32,0,64,INT32_MAX},
{96,INT32_MIN,INT32_MAX,-31},{95,-31,INT32_MAX,-30},{94,-30,INT32_MAX,-29},{93,-29,INT32_MAX,-28},{92,-28,INT32_MAX,-27},{91,-27,INT32_MAX,-26},{90,-26,INT32_MAX,-25},{89,-25,INT32_MAX,-24},{88,-24,INT32_MAX,-23},{87,-23,INT32_MAX,-22},{86,-22,INT32_MAX,-21},{85,-21,INT32_MAX,-20},{84,-20,INT32_MAX,-19},{83,-19,INT
//Fourth angle
{INT32_MIN,-8,31,INT32_MAX},
{31,-8,INT32_MAX,INT32_MAX},
{INT32_MIN,INT32_MIN,-1,-57},{INT32_MIN,-57,0,-56},{INT32_MIN,-56,2,-55},{INT32_MIN,-55,4,-54},{INT32_MIN,-54,6,-53},{INT32_MIN,-53,8,-52},{INT32_MIN,-52,10,-51},{INT32_MIN,-51,12,-50},{INT32_MIN,-50,14,-49},{INT32_MIN,-49,16,-48},{INT32_MIN,-48,18,-47},{INT32_MIN,-47,20,-46},{INT32_MIN,-46,22,-45},{INT32_MIN,-45,24,-44},{INT32_MIN,-44,26,-43},{INT32_MIN,-43,28,-42},{INT32_MIN,-42,30,-41},{INT32_MIN,-41,31,-8},
...
mask_t large_turn_right_to_orthogonal_gentle_up_masks[]={
{0,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+0},{0,0,-32,-16,large_turn_right_to_orthogonal_gentle_up_rects+1},{0,33,-64,16,large_turn_right_to_orthogonal_gentle_up_rects+1},{0,33,-96,16,large_turn_right_to_orthogonal_gentle_up_rects+34},
{0,17,0,0,large_turn_right_to_orthogonal_gentle_up_rects+67},{0,0,32,-16,large_turn_right_to_orthogonal_gentle_up_rects+84},{0,26,0,-16,large_turn_right_to_orthogonal_gentle_up_rects+84},{0,10,32,-16,large_turn_right_to_orthogonal_gentle_up_rects+110},
{0,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+120},{0,0,32,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{0,17,64,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{0,17,96,48,large_turn_right_to_orthogonal_gentle_up_rects+138},
{0,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+155},{0,1,-32,16,large_turn_right_to_orthogonal_gentle_up_rects+156},{0,18,0,48,large_turn_right_to_orthogonal_gentle_up_rects+157},{0,18,-32,80,large_turn_right_to_orthogonal_gentle_up_rects+175},
};

const track_section_t large_turn_right_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_EXIT_45_DEG_RIGHT,large_turn_right_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_right_to_orthogonal_gentle_up_masks},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 4},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 8},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 12}}};
...
const track_section_t gentle_up_to_gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_BANK_LEFT,gentle_up_to_gentle_up_left_bank_diag_curve,GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_to_gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_BANK_RIGHT,gentle_up_to_gentle_up_right_bank_diag_curve,GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_left_bank_to_gentle_up_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_ENTRY_BANK_LEFT,gentle_up_left_bank_to_gentle_up_diag_curve,GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_right_bank_to_gentle_up_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_ENTRY_BANK_RIGHT,gentle_up_right_bank_to_gentle_up_diag_curve,GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};

const track_section_t left_bank_to_gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_LEFT,left_bank_to_gentle_up_left_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t right_bank_to_gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_RIGHT,right_bank_to_gentle_up_right_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_left_bank_to_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_BANK_LEFT,gentle_up_left_bank_to_left_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_right_bank_to_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_BANK_RIGHT,gentle_up_right_bank_to_right_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_LEFT,gentle_up_left_bank_diag_curve,GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_RIGHT,gentle_up_right_bank_diag_curve,GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};

const track_section_t flat_to_gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_BANK_LEFT,flat_to_gentle_up_left_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t flat_to_gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_BANK_RIGHT,flat_to_gentle_up_right_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_left_bank_to_flat_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_ENTRY_BANK_LEFT,gentle_up_left_bank_to_flat_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t gentle_up_right_bank_to_flat_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_ENTRY_BANK_RIGHT,gentle_up_right_bank_to_flat_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};

const track_section_t large_turn_left_bank_to_diag_gentle_up={TRACK_EXIT_90_DEG_LEFT|TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_45_DEG_LEFT|TRACK_BANK_LEFT,large_turn_left_bank_to_diag_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_left_to_diag_gentle_up_masks},{0,4,large_turn_left_to_diag_gentle_up_masks + 4},{0,4,large_turn_left_to_diag_gentle_up_masks + 8},{0,4,large_turn_left_to_diag_gentle_up_masks + 12}}};


const track_section_t large_turn_right_bank_to_diag_gentle_up={TRACK_EXTRUDE_IN_FRONT|TRACK_EXIT_45_DEG_RIGHT|TRACK_BANK_RIGHT,large_turn_right_bank_to_diag_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_right_to_diag_gentle_up_masks},{0,4,large_turn_right_to_diag_gentle_up_masks + 4},{0,4,large_turn_right_to_diag_gentle_up_masks + 8},{0,4,large_turn_right_to_diag_gentle_up_masks + 12}}};


const track_section_t large_turn_left_bank_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_EXIT_45_DEG_LEFT|TRACK_BANK_LEFT,large_turn_left_bank_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_left_to_orthogonal_gentle_up_masks},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 4},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 8},{0,4,large_turn_left_to_orthogonal_gentle_up_masks + 12}}};


const track_section_t large_turn_right_bank_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_EXIT_45_DEG_RIGHT|TRACK_BANK_RIGHT,large_turn_right_bank_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,large_turn_right_to_orthogonal_gentle_up_masks},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 4},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 8},{0,4,large_turn_right_to_orthogonal_gentle_up_masks + 12}}};
...
{
return cubic_curve_vertical_diagonal(-0.5*FLAT_DIAG_LENGTH,-0.5*FLAT_DIAG_LENGTH,5*FLAT_DIAG_LENGTH,0,-2*CLEARANCE_HEIGHT,13*CLEARANCE_HEIGHT,0,0,9.15921042e-12,-7.64176033e-10,1.91775506e-08,-6.20557903e-08,-1.07682192e-05,2.95991517e-04,5.44333126e-02,distance);
}
track_point_t steep_to_flat_up_diag_curve(float distance)
{
return cubic_curve_vertical_diagonal(-0.5*FLAT_DIAG_LENGTH,2*FLAT_DIAG_LENGTH,2.5*FLAT_DIAG_LENGTH,0,-2*CLEARANCE_HEIGHT,-7*CLEARANCE_HEIGHT,20*CLEARANCE_HEIGHT,0,9.15921034e-12,-3.64783573e-10,-1.92055403e-09,1.77492141e-07,-8.30160814e-06,1.17635683e-04,5.68534428e-02,distance);
}
...
{
return cubic_curve_vertical_diagonal(-FLAT_DIAG_LENGTH/6,-FLAT_DIAG_LENGTH/6,5*FLAT_DIAG_LENGTH/6,-FLAT_DIAG_LENGTH/2,2*CLEARANCE_HEIGHT/3,-CLEARANCE_HEIGHT/3,20*CLEARANCE_HEIGHT/3,0,-1.27409679e-07,1.66746015e-06,-6.60784097e-06,2.87367949e-06,5.24290249e-04,-1.54572818e-03,1.70550125e-01,distance);
}
track_point_t vertical_to_steep_up_diag_curve(float distance)
{
return cubic_curve_vertical_diagonal(-FLAT_DIAG_LENGTH/6,2*FLAT_DIAG_LENGTH/3,0,0,-2*CLEARANCE_HEIGHT/3,CLEARANCE_HEIGHT,20*CLEARANCE_HEIGHT/3,0,-1.27409680e-07,3.35138224e-06,-3.50358430e-05,1.85655626e-04,-3.24817476e-05,-6.05934285e-03,2.00014155e-01,distance);
}
...
point.position=vector3(0.0,distance,0.0);
point.tangent=vector3(0.0,1.0,0.0);
point.normal=vector3(-sin(0.25*PI*distance/VERTICAL_TWIST_LENGTH),0.0,-cos(0.25*PI*distance/VERTICAL_TWIST_LENGTH));
point.binormal=vector3_cross(point.tangent,point.normal);
return point;
}
...
track_point_t vertical_twist_right_orthogonal_curve(float distance)
{
track_point_t point;
point.position=vector3(0.0,distance,0.0);
point.tangent=vector3(0.0,1.0,0.0);
...
/*
const track_section_t vertical_twist_left_to_diag_up={TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_90_DEG_LEFT,vertical_twist_left_to_diag_up_curve,VERTICAL_TWIST_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
const track_section_t vertical_twist_right_to_diag_up={TRACK_OFFSET_SPRITE_MASK|TRACK_NO_SUPPORTS,vertical_twist_right_to_diag_up_curve,VERTICAL_TWIST_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
const track_section_t vertical_twist_left_to_orthogonal_up={TRACK_OFFSET_SPRITE_MASK|TRACK_NO_SUPPORTS,vertical_twist_left_to_orthogonal_up_curve,VERTICAL_TWIST_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
const track_section_t vertical_twist_right_to_orthogonal_up={TRACK_OFFSET_SPRITE_MASK|TRACK_NO_SUPPORTS|TRACK_EXIT_90_DEG_RIGHT,vertical_twist_right_to_orthogonal_up_curve,VERTICAL_TWIST_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
{TRACK_MASK_TRANSFER_NEXT,1,0,0,medium_half_loop_left_rects+215},{TRACK_MASK_DIFFERENCE,1,32,0,medium_half_loop_left_rects+216},{0,2,64,24,medium_half_loop_left_rects+217},{0,33,32,8,medium_half_loop_left_rects+219},{0,33,0,136,medium_half_loop_left_rects+252},
{0,33,0,0,medium_half_loop_left_rects+285},{0,65,32,32,medium_half_loop_left_rects+318},{0,47,64,88,medium_half_loop_left_rects+383},{TRACK_MASK_TRANSFER_NEXT,48,96,72,medium_half_loop_left_rects+430},{TRACK_MASK_DIFFERENCE,33,64,168,medium_half_loop_left_rects+478},
};

const track_section_t medium_half_loop_left={TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_180_DEG,medium_half_loop_left_curve,MEDIUM_HALF_LOOP_LENGTH,{{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_left_masks},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_left_masks+5},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_left_masks+10},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_left_masks+15}}};


rect_t medium_half_loop_right_rects[]={
//First angle
{INT32_MIN,INT32_MIN,0,-30},{INT32_MIN,-30,1,-29},{INT32_MIN,-29,2,-28},{INT32_MIN,-28,3,-27},{INT32_MIN,-27,4,-26},{INT32_MIN,-26,5,-25},{INT32_MIN,-25,6,-24},{INT32_MIN,-24,7,-23},{INT32_MIN,-23,8,-22},{INT32_MIN,-22,9,-21},{INT32_MIN,-21,10,-20},{INT32_MIN,-20,11,-19},{INT32_MIN,-19,12,-18},{INT32_MIN,-18,13,-17},{INT32_MIN,-17,14,-16},{INT32_MIN,-16,15,-15},{INT32_MIN,-15,16,-14},{INT32_MIN,-14,17,-13},{INT32_MIN,-13,18,-12},{INT32_MIN,-12,19,-11},{INT32_MIN,-11,20,-10},{INT32_MIN,-10,21,-9},{INT32_MIN,-9,22,-8},{INT32_MIN,-8,23,-7},{INT32_MIN,-7,24,-6},{INT32_MIN,-6,25,-5},{INT32_MIN,-5,26,-4},{INT32_MIN,-4,27,-3},{INT32_MIN,-3,28,-2},{INT32_MIN,-2,29,-1},{INT32_MIN,-1,30,0},{INT32_MIN,0,31,1},{INT32_MIN,1,32,INT32_MAX},
{0,INT32_MIN,32,-71},{0,-71,33,-70},{0,-70,34,-69},{0,-69,35,-68},{0,-68,36,-67},{0,-67,37,-66},{0,-66,38,-65},{0,-65,39,-64},{0,-64,40,-63},{0,-63,41,-62},{0,-62,42,-61},{0,-61,43,-60},{0,-60,44,-59},{0,-59,45,-58},{0,-58,46,-57},{0,-57,47,-56},{0,-56,48,-55},{0,-55,49,-54},{0,-54,50,-53},{0,-53,51,-52},{0,-52,52,-51},{0,-51,53,-50},{0,-50,54,-49},{0,-49,55,-48},{0,-48,56,-47},{0,-47,57,-46},{0,-46,58,-45},{0,-45,59,-44},{0,-44,60,-43},{0,-43,61,-42},{0,-42,62,-41},{0,-41,63,-40},{0,-40,64,-30},{1,-30,64,-29},{2,-29,64,-28},{3,-28,64,-27},{4,-27,64,-26},{5,-26,64,-25},{6,-25,64,-24},{7,-24,64,-23},{8,-23,64,-22},{9,-22,64,-21},{10,-21,64,-20},{11,-20,64,-19},{12,-19,64,-18},{13,-18,64,-17},{14,
{-64,INT32_MIN,-32,-161},
{-32,INT32_MIN,INT32_MAX,-161},
};
mask_t medium_half_loop_right_masks[]={
{0,33,0,0,medium_half_loop_right_rects+0},{0,65,-32,32,medium_half_loop_right_rects+33},{0,47,-64,88,medium_half_loop_right_rects+98},{TRACK_MASK_TRANSFER_NEXT,48,-96,72,medium_half_loop_right_rects+145},{TRACK_MASK_DIFFERENCE,33,-64,168,medium_half_loop_right_rects+193},
{TRACK_MASK_TRANSFER_NEXT,1,0,0,medium_half_loop_right_rects+226},{TRACK_MASK_DIFFERENCE,1,-32,0,medium_half_loop_right_rects+227},{0,2,-64,24,medium_half_loop_right_rects+228},{0,33,-32,8,medium_half_loop_right_rects+230},{0,33,0,136,medium_half_loop_right_rects+263},
{0,2,0,0,medium_half_loop_right_rects+296},{0,1,32,0,medium_half_loop_right_rects+298},{0,1,64,24,medium_half_loop_right_rects+299},{0,66,96,40,medium_half_loop_right_rects+300},{0,65,64,168,medium_half_loop_right_rects+366},
{0,22,0,0,medium_half_loop_right_rects+431},{0,38,32,32,medium_half_loop_right_rects+453},{0,18,64,88,medium_half_loop_right_rects+491},{TRACK_MASK_TRANSFER_NEXT,1,32,104,medium_half_loop_right_rects+509},{TRACK_MASK_DIFFERENCE,1,0,200,medium_half_loop_right_rects+510},
};

const track_section_t medium_half_loop_right={TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_180_DEG,medium_half_loop_right_curve,MEDIUM_HALF_LOOP_LENGTH,{{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_right_masks},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_right_masks+5},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_right_masks+10},{VIEW_NEEDS_TRACK_MASK,5,medium_half_loop_right_masks+15}}};
...
const track_section_t large_half_loop_left={TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_180_DEG,large_half_loop_left_curve,LARGE_HALF_LOOP_LENGTH,{{0,7,large_half_loop_left_masks},{0,7,large_half_loop_left_masks+7},{0,7,large_half_loop_left_masks+14},{0,7,large_half_loop_left_masks+21}}};
...
const track_section_t large_half_loop_right={TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_180_DEG,large_half_loop_right_curve,LARGE_HALF_LOOP_LENGTH,{{0,7,large_half_loop_right_masks},{0,7,large_half_loop_right_masks+7},{0,7,large_half_loop_right_masks+14},{0,7,large_half_loop_right_masks+21}}};
...
const track_section_t small_turn_left_bank_to_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_ENTRY_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT,small_turn_left_bank_to_gentle_up_curve,TURN_BANK_TRANSITION_LENGTH,{{0,2,small_turn_left_bank_to_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,3,small_turn_left_bank_to_gentle_up_masks+2},{0,2,small_turn_left_bank_to_gentle_up_masks+5},{0,2,small_turn_left_bank_to_gentle_up_masks+7}}};
...
const track_section_t small_turn_right_bank_to_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_ENTRY_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,small_turn_right_bank_to_gentle_up_curve,TURN_BANK_TRANSITION_LENGTH,{{0,2,small_turn_right_bank_to_gentle_up_masks},{0,2,small_turn_right_bank_to_gentle_up_masks+2},{VIEW_NEEDS_TRACK_MASK,3,small_turn_right_bank_to_gentle_up_masks+4},{0,2,small_turn_right_bank_to_gentle_up_masks+7}}};
...
const track_section_t corkscrew_left={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_CORKSCREW_LEFT|TRACK_EXIT_90_DEG_LEFT,corkscrew_left_curve,CORKSCREW_LENGTH,{{VIEW_NEEDS_TRACK_MASK,3,corkscrew_left_masks},{VIEW_NEEDS_TRACK_MASK,3,corkscrew_left_masks+3},{0,3,corkscrew_left_masks+6},{VIEW_NEEDS_TRACK_MASK,3,corkscrew_left_mas
-64,-137,-2,-136},{-64,-136,0,-110},{-62,-110,0,-109},{-60,-109,0,-108},{-58,-108,0,-107},{-56,-107,0,-106},{-54,-106,0,-105},{-52,-105,0,-104},{-50,-104,0,-103},{-48,-103,0,-102},{-46,-102,0,-101},{-44,-101,0,-100},{-42,-100,0,-99},{-40,-99,0,-98},{-38,-98,0,-97},{-36,-97,0,-96},{-34,-96,0,-95},{-32,-95,0,-94},{-30,-94,0,-93},{-28,-93,0,-92},{-26,-92,0,-91},{-24,-91,0,-90},{-22,-90,0,-89},{-20,-89,0,-88},{-18,-88,0,-87},{-16,-87,0,-86},{-14,-86,0,-85},{-12,-85,0,-84},{-10,-84,0,-83},{-8,-83,0,-82},{-6,-82,0,-81},{-4,-81,0,-80},{-2,-80,0,-79},
{-32,INT32_MIN,INT32_MAX,-151},{-30,-151,INT32_MAX,-150},{-28,-150,INT32_MAX,-149},{-26,-149,INT32_MAX,-148},{-24,-148,INT32_MAX,-147},{-22,-147,INT32_MAX,-146},{-20,-146,INT32_MAX,-145},{-18,-145,INT32_MAX,-144},{-16,-144,INT32_MAX,-143},{-14,-143,INT32_MAX,-142},{-12,-142,INT32_MAX,-141},{-10,-141,INT32_MAX,-140},{-8,-140,INT32_MAX,-139},{-6,-139,INT32_MAX,-138},{-4,-138,INT32_MAX,-137},{-2,-137,INT32_MAX,-136},{0,-136,INT32_MAX,-64},
};
mask_t large_corkscrew_right_masks[]={
{0,17,0,0,large_corkscrew_right_rects+0},{0,49,-32,24,large_corkscrew_right_rects+17},{0,50,-64,64,large_corkscrew_right_rects+66},{TRACK_MASK_TRANSFER_NEXT,32,-96,64,large_corkscrew_right_rects+116},{TRACK_MASK_DIFFERENCE,1,-128,72,large_corkscrew_right_rects+148},
{0,1,0,0,large_corkscrew_right_rects+149},{TRACK_MASK_TRANSFER_NEXT,23,-32,-8,large_corkscrew_right_rects+150},{TRACK_MASK_DIFFERENCE,24,-64,0,large_corkscrew_right_rects+173},{0,1,-32,0,large_corkscrew_right_rects+197},{0,1,0,8,large_corkscrew_right_rects+198},
{TRACK_MASK_TRANSFER_NEXT,1,0,0,large_corkscrew_right_rects+199},{TRACK_MASK_DIFFERENCE,17,32,-8,large_corkscrew_right_rects+200},{0,49,64,0,large_corkscrew_right_rects+217},{0,65,96,32,large_corkscrew_right_rects+266},{0,33,128,72,large_corkscrew_right_rects+331},
...
const track_section_t large_corkscrew_right={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_EXIT_90_DEG_RIGHT,large_corkscrew_right_curve,LARGE_CORKSCREW_LENGTH,{{VIEW_NEEDS_TRACK_MASK,5,large_corkscrew_right_masks},{VIEW_NEEDS_TRACK_MASK,5,large_corkscrew_right_masks+5},{VIEW_NEEDS_TRACK_MASK,5,large_corkscrew_right_masks+10},{VIEW_NEEDS_TRACK_MASK,5,large_corkscrew_right_masks+15}}};



rect_t zero_g_roll_left_rects[]={
//First angle
};
mask_t zero_g_roll_left_masks[]={
{TRACK_MASK_INTERSECT,25,0,0,zero_g_roll_left_rects+0},{TRACK_MASK_DIFFERENCE,25,0,0,zero_g_roll_left_rects+0},{0,57,-32,24,zero_g_roll_left_rects+25},{0,32,-64,56,zero_g_roll_left_rects+82},
{TRACK_MASK_INTERSECT,1,0,0,zero_g_roll_left_rects+114},{TRACK_MASK_DIFFERENCE,1,0,0,zero_g_roll_left_rects+114},{0,1,-32,-8,zero_g_roll_left_rects+115},{0,1,-64,-8,zero_g_roll_left_rects+116},
{0,18,0,0,zero_g_roll_left_rects+117},{0,28,32,-8,zero_g_roll_left_rects+135},{TRACK_MASK_INTERSECT,14,64,-8,zero_g_roll_left_rects+163},{TRACK_MASK_DIFFERENCE,14,64,-8,zero_g_roll_left_rects+163},
{0,34,0,0,zero_g_roll_left_rects+177},{0,52,32,24,zero_g_roll_left_rects+211},{TRACK_MASK_INTERSECT,20,64,56,zero_g_roll_left_rects+263},{TRACK_MASK_DIFFERENCE,20,64,56,zero_g_roll_left_rects+263},
};

rect_t zero_g_roll_right_rects[]={
//First angle
{INT32_MIN,-42,-7,-40},{INT32_MIN,-40,-6,-39},{INT32_MIN,-39,-5,-38},{INT32_MIN,-38,-4,-37},{INT32_MIN,-37,-3,-36},{INT32_MIN,-36,-2,-34},{INT32_MIN,-34,-1,-33},{INT32_MIN,-33,0,-32},{INT32_MIN,-32,1,-31},{INT32_MIN,-31,2,-30},{INT32_MIN,-30,3,-29},{INT32_MIN,-29,4,-27},{INT32_MIN,-27,5,-26},{INT32_MIN,-26,6,-25},{INT32_MIN,-25,7,-24},{INT32_MIN,-24,8,-23},{INT32_MIN,-23,9,-21},{INT32_MIN,-21,10,-20},{INT32_MIN,-20,11,-19},{INT32_MIN,-19,12,-18},{INT32_MIN,-18,13,-17},{INT32_MIN,-17,14,-16},{INT32_MIN,-16,15,-14},{INT32_MIN,-14,16,-13},{INT32_MIN,-13,17,-12},{INT32_MIN,-12,18,-11},{INT32_MIN,-11,19,-10},{INT32_MIN,-10,20,-8},{INT32_MIN,-8,21,-7},{INT32_MIN,-7,22,-6},{INT32_MIN,-6,23,-5},{INT32_MIN,-5,24,-4},{INT32_MIN,-4,25,-3},{INT32_MIN,-3,26,INT32_MAX},
{INT32_MIN,INT32_MIN,32,-77},{INT32_MIN,-77,33,-75},{INT32_MIN,-75,34,-73},{INT32_MIN,-73,35,-71},{INT32_MIN,-71,36,-69},{INT32_MIN,-69,37,-67},{INT32_MIN,-67,38,-65},{INT32_MIN,-65,39,-63},{INT32_MIN,-63,40,-61},{INT32_MIN,-61,41,-59},{INT32_MIN,-59,42,-57},{INT32_MIN,-57,43,-54},{INT32_MIN,-54,44,-52},{INT32_MIN,-52,45,-50},{INT32_MIN,-50,46,-48},{INT32_MIN,-48,47,-46},{INT32_MIN,-46,48,-44},{INT32_MIN,-44,49,-42},{-7,-42,50,-40},{-6,-40,51,-39},
},{INT32_MIN,-15,-23,-14},{INT32_MIN,-14,-25,-13},{INT32_MIN,-13,-27,-12},{INT32_MIN,-12,-29,-11},{INT32_MIN,-11,-31,-10},{INT32_MIN,-10,-33,-9},{INT32_MIN,-9,-35,-8},{INT32_MIN,-8,-37,-7},{INT32_MIN,-7,-39,-6},{INT32_MIN,-6,-41,-5},{INT32_MIN,-5,-43,-4},{INT32_MIN,-4,-45,INT32_MAX},
{INT32_MIN,INT32_MIN,-32,-59},{INT32_MIN,-59,-33,-58},{INT32_MIN,-58,-34,-57},{INT32_MIN,-57,-35,-56},{INT32_MIN,-56,-37,-55},{INT32_MIN,-55,-38,-54},{INT32_MIN,-54,-39,-53},{INT32_MIN,-53,-40,-52},{INT32_MIN,-52,-41,-51},{INT32_MIN,-51,-43,-50},{INT32_MIN,-50,-44,-49},{INT32_MIN,-49,-45,-48},{INT32_MIN,-48,-46,-47},{INT32_MIN,-47,-48,-46},{INT32_MIN,-46,-49,-45},{INT32_MIN,-45,-50,-44},{INT32_MIN,-44,-51,-43},{INT32_MIN,-43,-52,-42},{INT32_MIN,-42,-54,-41},{INT32_MIN,-41,-55,-40},{INT32_MIN,-40,-56,-39},{INT32_MIN,-39,-57,-38},{INT32_MIN,-38,-58,-37},{INT32_MIN,-37,-60,-36},{INT32_MIN,-36,-61,-35},{INT32_MIN,-35,-62,-34},{INT32_MIN,-34,-63,-33},{INT32_MIN,-33,-64,-32},{INT32_MIN,-32,-66,-31},{INT32_MIN,-31,-67,-30},{INT32_MIN,-30,-68,-29},{INT32_MIN,-29,-69,-28},
};
mask_t zero_g_roll_right_masks[]={
{0,34,0,0,zero_g_roll_right_rects+0},{0,52,-32,24,zero_g_roll_right_rects+34},{TRACK_MASK_INTERSECT,20,-64,56,zero_g_roll_right_rects+86},{TRACK_MASK_DIFFERENCE,20,-64,56,zero_g_roll_right_rects+86},
{0,18,0,0,zero_g_roll_right_rects+106},{0,28,-32,-8,zero_g_roll_right_rects+124},{TRACK_MASK_INTERSECT,14,-64,-8,zero_g_roll_right_rects+152},{TRACK_MASK_DIFFERENCE,14,-64,-8,zero_g_roll_right_rects+152},
{TRACK_MASK_INTERSECT,1,0,0,zero_g_roll_right_rects+166},{TRACK_MASK_DIFFERENCE,1,0,0,zero_g_roll_right_rects+166},{0,1,32,-8,zero_g_roll_right_rects+167},{0,1,64,-8,zero_g_roll_right_rects+168},
{TRACK_MASK_INTERSECT,25,0,0,zero_g_roll_right_rects+169},{TRACK_MASK_DIFFERENCE,25,0,0,zero_g_roll_right_rects+169},{0,57,32,24,zero_g_roll_right_rects+194},{0,32,64,56,zero_g_roll_right_rects+251},
};


const track_section_t zero_g_roll_left={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_ZERO_G_ROLL_LEFT,zero_g_roll_left_curve,ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_left_masks},{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_left_masks+4},{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_left_masks+8},{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_left_masks+12}}};
const track_section_t zero_g_roll_right={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_ZERO_G_ROLL_RIGHT,zero_g_roll_right_curve,ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_right_masks},{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll_right_masks+4},{VIEW_NEEDS_TRACK_MASK,4,zero_g_roll
{0,49,0,0,large_zero_g_roll_left_rects+134},{0,54,-32,40,large_zero_g_roll_left_rects+183},{0,28,-64,64,large_zero_g_roll_left_rects+237},{0,5,-96,72,large_zero_g_roll_left_rects+265},
{TRACK_MASK_INTERSECT,33,0,0,large_zero_g_roll_left_rects+270},{TRACK_MASK_DIFFERENCE,33,0,0,large_zero_g_roll_left_rects+270},{0,65,32,40,large_zero_g_roll_left_rects+303},{0,33,64,64,large_zero_g_roll_left_rects+368},{TRACK_MASK_INTERSECT,1,96,72,large_zero_g_roll_left_rects+401},{TRACK_MASK_DIFFERENCE,1,96,72,large_zero_g_roll_left_rects+401},
{0,17,0,0,large_zero_g_roll_left_rects+402},{0,33,32,72,large_zero_g_roll_left_rects+419},{TRACK_MASK_INTERSECT,49,64,128,large_zero_g_roll_left_rects+452},{TRACK_MASK_DIFFERENCE,49,64,128,large_zero_g_roll_left_rects+452},{0,33,96,168,large_zero_g_roll_left_rects+501},
};

rect_t large_zero_g_roll_right_rects[]={
//First angle
{INT32_MIN,INT32_MIN,0,-47},{INT32_MIN,-47,2,-46},{INT32_MIN,-46,4,-45},{INT32_MIN,-45,6,-44},{INT32_MIN,-44,8,-43},{INT32_MIN,-43,10,-42},{INT32_MIN,-42,12,-41},{INT32_MIN,-41,14,-40},{INT32_MIN,-40,16,-39},{INT32_MIN,-39,18,-38},{INT32_MIN,-38,20,-37},{INT32_MIN,-37,22,-36},{INT32_MIN,-36,24,-35},{INT32_MIN,-35,26,-34},{INT32_MIN,-34,28,-33},{INT32_MIN,-33,30,-32},{INT32_MIN,-32,32,INT32_MAX},
{0,INT32_MIN,32,-119},{0,-119,34,-118},{0,-118,36,-117},{0,-117,38,-116},{0,-116,40,-115},{0,-115,42,-114},{0,-114,44,-113},{0,-113,46,-112},{0,-112,48,-111},{0,-111,50,-110},{0,-110,52,-109},{0,-109,54,-108},{0,-108,56,-107},{0,-107,58,-106},{0,-106,60,-105},{0,-105,62,-104},{0,-104,64,-47},{2,-47,64,-46},{4,-46,64,-45},{6,-45,64,-44},{8,-44,64,-43},{10,-43,64,-42},{12,-42,64,-41},{14,-41,64,-40},{16,-40,64,-39},{18,-39,64,-38},{20,-38,64,-37},{22,-37,64,-36},{24,-36,64,-35},{26,-35,64,-34},{28,-34,64,-33},{30,-33,64,-32},{32,-32,64,INT32_MAX},
{32,INT32_MIN,64,-169},{32,-169,65,-168},{32,-168,66,-167},{32,-167,67,-166},{32,-166,68,-165},{32,-165,69,-164},{32,-164,70,-163},{32,-163,71,-162},{32,-162,72,-161},{32,-161,73,-160},{32,-160,74,-159},{32,-159,75,-158},{32,-158,76,-157},{32,-157,77,-156},{32,-156,78,-155},{32,-155,79,-154},{32,-154,80,-153},{32,-153,81,-152},{32,-152,82,-151},{32,-151,83,-150},{32,-150,84,-149},{32,-149,85,-148},{32,-148,86,-147},{32,-147,87,-146},{32,-146,88,-145},{32,-145,89,-144},{
T32_MIN,-171,-76,-170},{INT32_MIN,-170,-77,-169},{INT32_MIN,-169,-78,-168},{INT32_MIN,-168,-79,-167},{INT32_MIN,-167,-80,-166},{INT32_MIN,-166,-81,-165},{INT32_MIN,-165,-82,-164},{INT32_MIN,-164,-83,-163},{INT32_MIN,-163,-84,-162},{INT32_MIN,-162,-85,-161},{INT32_MIN,-161,-86,-160},{INT32_MIN,-160,-87,-159},{INT32_MIN,-159,-88,-158},{INT32_MIN,-158,-89,-157},{INT32_MIN,-157,-90,-156},{INT32_MIN,-156,-91,-155},{INT32_MIN,-155,-92,-154},{INT32_MIN,-154,-93,-153},{INT32_MIN,-153,-94,-152},{INT32_MIN,-152,-95,-151},{INT32_MIN,-151,-96,INT32_MAX},
};
mask_t large_zero_g_roll_right_masks[]={
{0,17,0,0,large_zero_g_roll_right_rects+0},{0,33,-32,72,large_zero_g_roll_right_rects+17},{TRACK_MASK_INTERSECT,49,-64,128,large_zero_g_roll_right_rects+50},{TRACK_MASK_DIFFERENCE,49,-64,128,large_zero_g_roll_right_rects+50},{0,33,-96,168,large_zero_g_roll_right_rects+99},
{TRACK_MASK_INTERSECT,33,0,0,large_zero_g_roll_right_rects+132},{TRACK_MASK_DIFFERENCE,33,0,0,large_zero_g_roll_right_rects+132},{0,65,-32,40,large_zero_g_roll_right_rects+165},{0,33,-64,64,large_zero_g_roll_right_rects+230},{TRACK_MASK_INTERSECT,1,-96,72,large_zero_g_roll_right_rects+263},{TRACK_MASK_DIFFERENCE,1,-96,72,large_zero_g_roll_right_rects+263},
{0,49,0,0,large_zero_g_roll_right_rects+264},{0,54,32,40,large_zero_g_roll_right_rects+313},{0,28,64,64,large_zero_g_roll_right_rects+367},{0,5,96,72,large_zero_g_roll_right_rects+395},
{0,18,0,0,large_zero_g_roll_right_rects+400},{TRACK_MASK_INTERSECT,34,32,72,large_zero_g_roll_right_rects+418},{TRACK_MASK_DIFFERENCE,34,32,72,large_zero_g_roll_right_rects+418},{0,49,64,128,large_zero_g_roll_right_rects+452},{0,33,96,168,large_zero_g_roll_right_rects+501},
};

const track_section_t large_zero_g_roll_left={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_LARGE_ZERO_G_ROLL_LEFT|TRACK_ALT_INVERT|TRACK_ALT_PREFER_ODD,large_zero_g_roll_left_curve,LARGE_ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,5,large_zero_g_roll_left_masks},{0,4,large_zero_g_roll_left_masks+5},{VIEW_NEEDS_TRACK_MASK,6,large_zero_g_roll_left_masks+9},{VIEW_NEEDS_TRACK_MASK,5,large_zero_g_roll_left_masks+15}}};
const track_section_t large_zero_g_roll_right={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_LARGE_ZERO_G_ROLL_RIGHT|TRACK_ALT_INVERT|TRACK_ALT_PREFER_ODD,large_zero_g_roll_right_curve,LARGE_ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,5,large_zero_g_roll_right_masks},{VIEW_NEEDS_TRACK_MASK,6,large_zero_g_roll_right_masks+5},{0,4,large_zero_g_roll_right_masks+11},{VIEW_NEEDS_TRACK_MASK,5,large_zero_g_roll_right_masks+15}}};
...
const track_section_t gentle_to_steep_up={TRACK_ALT_PREFER_ODD,gentle_to_steep_up_curve,GENTLE_TO_STEEP_LENGTH,{{0,1,NULL},{VIEW_NEEDS_TRACK_MASK,2,gentle_to_steep_up_masks},{VIEW_NEEDS_TRACK_MASK,2,gentle_to_steep_up_masks+2},{0,1,NULL}}};
...
const track_section_t steep_to_gentle_up={TRACK_ALT_INVERT|TRACK_ALT_PREFER_ODD,steep_to_gentle_up_curve,GENTLE_TO_STEEP_LENGTH,{{0,1,NULL},{VIEW_NEEDS_TRACK_MASK,2,steep_to_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,2,steep_to_gentle_up_masks+2},{0,1,NULL}}};
const track_section_t steep={TRACK_ALT_INVERT,steep_curve,STEEP_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
const track_section_t steep_to_vertical_up={TRACK_VERTICAL|TRACK_NO_SUPPORTS|TRACK_SPECIAL_STEEP_TO_VERTICAL|TRACK_ALT_INVERT,steep_to_vertical_up_curve,STEEP_TO_VERTICAL_LENGTH,{{0,1,NULL},{0,1,NULL},{0,1,NULL},{0,1,NULL}}};
...
const track_section_t small_turn_left={TRACK_EXIT_90_DEG_LEFT,small_turn_left_curve,SMALL_TURN_LENGTH,{{0,3,small_turn_masks},{0,3,small_turn_masks+3},{0,3,small_turn_masks+6},{0,3,small_turn_masks+9}}};
...
const track_section_t medium_turn_left={TRACK_EXIT_90_DEG_LEFT,medium_turn_left_curve,MEDIUM_TURN_LENGTH,{{0,5,medium_turn_left_masks},{0,5,medium_turn_left_masks+5},{0,5,medium_turn_left_masks+10},{0,5,medium_turn_left_masks+15}}};
...
const track_section_t large_turn_left_to_diag={TRACK_EXIT_45_DEG_LEFT,large_turn_left_to_diag_curve,LARGE_TURN_LENGTH,{{0,4,large_turn_left_to_diag_masks},{0,4,large_turn_left_to_diag_masks+4},{0,4,large_turn_left_to_diag_masks+8},{0,4,large_turn_left_to_diag_masks+12}}};
...
const track_section_t large_turn_right_to_diag={TRACK_EXIT_45_DEG_RIGHT,large_turn_right_to_diag_curve,LARGE_TURN_LENGTH,{{0,4,large_turn_right_to_diag_masks},{0,4,large_turn_right_to_diag_masks+4},{0,4,large_turn_right_to_diag_masks+8},{0,4,large_turn_right_to_diag_masks+12}}};
...
const track_section_t small_turn_left_bank={TRACK_BANK_LEFT|TRACK_EXIT_90_DEG_LEFT,small_turn_left_bank_curve,0.75*TILE_SIZE*3.1415926,{{VIEW_NEEDS_TRACK_MASK,4,small_turn_left_bank_masks},{0,3,small_turn_left_bank_masks+4},{VIEW_NEEDS_TRACK_MASK,4,small_turn_left_bank_masks+7},{0,3,small_turn_left_bank_masks+11}}};
...
const track_section_t medium_turn_left_bank={TRACK_BANK_LEFT|TRACK_EXIT_90_DEG_LEFT,medium_turn_left_bank_curve,1.25*TILE_SIZE*3.1415926,{{VIEW_NEEDS_TRACK_MASK,6,medium_turn_left_bank_masks},{0,5,medium_turn_left_bank_masks+6},{VIEW_NEEDS_TRACK_MASK,6,medium_turn_left_bank_masks+11},{0,5,medium_turn_left_bank_masks+17}}};
...
const track_section_t large_turn_left_to_diag_bank={TRACK_BANK_LEFT|TRACK_EXIT_45_DEG_LEFT,large_turn_left_to_diag_bank_curve,0.875*TILE_SIZE*3.1415926,{{0,4,large_turn_left_to_diag_bank_masks},{0,4,large_turn_left_to_diag_bank_masks+4},{0,4,large_turn_left_to_diag_bank_masks+8},{0,4,large_turn_left_to_diag_bank_masks+12}}};
...
const track_section_t large_turn_right_to_diag_bank={TRACK_BANK_RIGHT|TRACK_EXIT_45_DEG_RIGHT,large_turn_right_to_diag_bank_curve,0.875*TILE_SIZE*3.1415926,{{0,4,large_turn_right_to_diag_bank_masks},{0,4,large_turn_right_to_diag_bank_masks+4},{0,4,large_turn_right_to_diag_bank_masks+8},{0,4,large_turn_right_to_diag_bank_masks+12}}};
...
const track_section_t small_turn_right_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,small_turn_right_gentle_up_curve,SMALL_TURN_GENTLE_LENGTH,{{0,2,small_turn
N,-33,-118,-31},{INT32_MIN,-31,-119,-30},{INT32_MIN,-30,-120,-29},{INT32_MIN,-29,-121,-28},{INT32_MIN,-28,-122,-27},{INT32_MIN,-27,-123,-25},{INT32_MIN,-25,-124,-24},{INT32_MIN,-24,-125,-23},{INT32_MIN,-23,-126,-22},{INT32_MIN,-22,-127,-20},{INT32_MIN,-20,-128,INT32_MAX},
//Fourth angle
{0,-46,INT32_MAX,-16},{-32,-16,INT32_MAX,INT32_MAX},
{INT32_MIN,-46,0,-16},{INT32_MIN,-16,-32,INT32_MAX},
{INT32_MIN,INT32_MIN,-32,-91},{INT32_MIN,-91,0,-46},
...
{0,33,0,0,medium_turn_right_gentle_up_rects+0},{0,36,-32,32,medium_turn_right_gentle_up_rects+33},{0,43,-64,24,medium_turn_right_gentle_up_rects+69},{0,53,-96,48,medium_turn_right_gentle_up_rects+112},{0,45,-128,48,medium_turn_right_gentle_up_rects+165},
{0,2,0,0,medium_turn_right_gentle_up_rects+210},{0,0,-32,0,medium_turn_right_gentle_up_rects+212},{0,1,0,-8,medium_turn_right_gentle_up_rects+212},{0,0,-32,-8,medium_turn_right_gentle_up_rects+213},{0,2,0,-16,medium_turn_right_gentle_up_rects+213},
{0,1,0,0,medium_turn_right_gentle_up_rects+215},{0,1,32,0,medium_turn_right_gentle_up_rects+216},{0,32,64,24,medium_turn_right_gentle_up_rects+217},{0,76,96,16,medium_turn_right_gentle_up_rects+249},{0,65,128,48,medium_turn_right_gentle_up_rects+325},
{0,2,0,0,medium_turn_right_gentle_up_rects+390},{0,2,32,32,medium_turn_right_gentle_up_rects+392},{0,0,0,56,medium_turn_right_gentle_up_rects+394},{0,2,32,80,medium_turn_right_gentle_up_rects+394},{0,2,0,112,medium_turn_right_gentle_up_rects+396},
};

const track_section_t medium_turn_right_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,medium_turn_right_gentle_up_curve,MEDIUM_TURN_GENTLE_LENGTH,{{0,5,medium_turn_right_gentle_up_masks},{0,5,medium_turn_right_gentle_up_masks+5},{0,5,medium_turn_right_gentle_up_masks+10},{0,5,medium_turn_right_gentle_up_masks+15}}};
...
const track_section_t very_small_turn_right_steep_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT|TRACK_ALT_INVERT,very_small_turn_right_steep_up_curve,VERY_SMALL_TURN_STEEP_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,very_small_turn_right_steep_up_masks},{0,2,very_small_turn_right_steep_up_masks+2},{VIEW_NEEDS_TRACK_MASK,2,very_small_turn_right_steep_up_masks+4},{0,2,very_small_turn_right_steep_up_masks+6}}};
...
const track_section_t vertical_twist_left_up={TRACK_VERTICAL|TRACK_OFFSET_SPRITE_MASK|TRACK_NO_SUPPORTS|TRACK_SPECIAL_VERTICAL_TWIST_LEFT|TRACK_EXIT_90_DEG_LEFT,vertical_twist_left_up_curve,VERTICAL_TWIST_LENGTH,{{0,1,NULL},{0,2,vertical_twist_left_up_masks},{0,1,NULL},{0,2,vertical_twist_left_up_masks+2}}};
...
const track_section_t vertical_twist_right_up={TRACK_VERTICAL|TRACK_OFFSET_SPRITE_MASK|TRACK_NO_SUPPORTS|TRACK_SPECIAL_VERTICAL_TWIST_RIGHT|TRACK_EXIT_90_DEG_RIGHT,vertical_twist_right_up_curve,VERTICAL_TWIST_LENGTH,{{0,2,vertical_twist_right_up_masks},{0,1,NULL},{0,2,vertical_twist_right_up_masks+2},{0,1,NULL}}};
...
const track_section_t small_turn_left_bank_gentle_up={TRACK_BANK_LEFT|TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT,small_turn_left_bank_gentle_up_curve,SMALL_TURN_GENTLE_LENGTH,{{0,2,small_turn_left_gentle_up_masks},{0,2,small_turn_left_gentle_up_masks+2},{0,2,small_turn_left_gentle_up_masks+4},{0,2,small_turn_left_gentle_up_masks+6}}};
const track_section_t small_turn_right_bank_gentle_up={TRACK_BANK_RIGHT|TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,small_turn_right_bank_gentle_up_curve,SMALL_TURN_GENTLE_LENGTH,{{0,2,small_turn_right_gentle_up_masks},{0,2,small_turn_right_gentle_up_masks+2},{0,2,small_turn_right_gentle_up_masks+4},{0,2,small_turn_right_gentle_up_masks+6}}};
...
rect_t medium_turn_bank_gentle_up_rects[]={
//First angle
{-32,INT32_MIN,INT32_MAX,-9},{-31,-9,INT32_MAX,-8},{-30,-8,INT32_MAX,-7},{-29,-7,INT32_MAX,-6},{-28,-6,INT32_MAX,-5},{-27,-5,INT32_MAX,-4},{-26,-4,INT32_MAX,-3},{-25,-3,INT32_MAX,-2},{-24,-2,INT32_MAX,-1},{-23,-1,INT32_MAX,0},{-22,0,INT32_MAX,1},{-21,1,INT32_MAX,2},{-20,2,INT32_MAX,3},{-19,3,INT32_MAX,4},{-18,4,INT32_MAX,5},{-17,5,INT32_MAX,6},{-16,6,INT32_MAX,9},{-21,9,INT32_MAX,10},{-22,10,INT32_MAX,11},{-23,11,INT32_MAX,12},{-24,12,INT32_MAX,13},{-25,13,INT32_MAX,14},{-26,14,INT32_MAX,15},{-27,15,INT32_MAX,16},{-28,16,INT32_MAX,17},{-29,17,INT32_MAX,18},{-30,18,INT32_MAX,19},{-31,19,INT32_MAX,20},{-32,20,INT32_MAX,INT32_MAX},
{INT32_MIN,INT32_MIN,-32,-9},{INT32_MIN,-9,-31,-8},{INT32_MIN,-8,-30,-7},{INT32_MIN,-7,-29,-6},{INT32_MIN,-6,-28,-5},{INT32_MIN,-5,-27,-4},{INT32_MIN,-4,-26,-3},{INT32_MIN,-3,-25,-2},{INT32_MIN,-2,-24,-1},{INT32_MIN,-1,-23,0},{INT32_MIN,0,-22,1},{INT32_MIN,1,-21,2},{INT32_MIN,2,-20,3},{INT32_MIN,3,-19,4},{INT32_MIN,4,-18,5},{INT32_MIN,5,-17,6},{INT32_MIN,6,-16,9},{INT32_MIN,9,-21,10},{INT32_MIN,10,-22,11},{INT32_MIN,11,-23,12},{INT32_MIN,12,-24,13},{INT32_MIN,13,-25,14},{INT32_MIN,14,-26,15},{INT32_MIN,15,-27,16},{INT32_MIN,16,-28,17},{INT32_MIN,17,-29,18},{INT32_MIN,18,-30,19},{INT32_MIN,19,-31,20},{INT32_MIN,20,-32,INT32_MAX},
//Second angle
{INT32_MIN,INT32_MIN,32,-9},{INT32_MIN,-9,31,-8},{INT32_MIN,-8,30,-7},{INT32_MIN,-7,29,-6},{INT32_MIN,-6,28,-5},{INT32_MIN,-5,27,-4},{INT32_MIN,-4,26,-3},{INT32_MIN,-3,25,-2},{INT32_MIN,-2,24,-1},{INT32_MIN,-1,23,0},{INT32_MIN,0,22,1},{INT32_MIN,1,21,2},{INT32_MIN,2,20,3},{INT32_MIN,3,19,4},{INT32_MIN,4,18,5},{INT32_MIN,5,17,6},{INT32_MIN,6,16,9},{INT32_MIN,9,21,10},{INT32_MIN,10,22,11},{INT32_MIN,11,23,12},{INT32_MIN,12,24,13},{INT32_MIN,13,25,14},{INT32_MIN,14,26,15},{INT32_MIN,15,27,16},{INT32_MIN,16,28,17},{INT32_MIN,17,29,18},{INT32_MIN,18,30,19},{INT32_MIN,19,31,20},{INT32_MIN,20,32,INT32_MAX},
{32,INT32_MIN,INT32_MAX,-9},{31,-9,INT32_MAX,-8},{30,-8,INT32_MAX,-7},{29,-7,INT32_MAX,-6},{28,-6,INT32_MAX,-5},{27,-5,INT32_MAX,-4},{26,-4,INT32_MAX,-3},{25,-3,INT32_MAX,-2},{24,-2,INT32_MAX,-1},{23,-1,INT32_MAX,0},{22,0,INT32_MAX,1},{21,1,INT32_MAX,2},{20,2,INT32_MAX,3},{19,3,INT32_MAX,4},{18,4,INT32_MAX,5},{17,5,INT32_MAX,6},{16,6,INT32_MAX,9},{21,9,INT32_MAX,10},{22,10,INT32_MAX,11},{23,11,INT32_MAX,12},{24,12,INT32_MAX,13},{25,13,INT32_MAX,14},{26,14,INT32_MAX,15},{27,15,INT32_MAX,16},{28,16,INT32_MAX,17},{29,17,INT32_MAX,18},{30,18,INT32_MAX,19},{31,19,INT32_MAX,20},{32,20,INT32_MAX,INT32_MAX},
};
...
mask_t medium_turn_left_bank_gentle_up_masks[]={
{0,2,0,0,medium_turn_left_gentle_up_rects+0},{0,2,-32,32,medium_turn_left_gentle_up_rects+2},{0,0,0,0,medium_turn_left_gentle_up_rects+4},{0,2,-32,80,medium_turn_left_gentle_up_rects+4},{0,2,0,112,medium_turn_left_gentle_up_rects+6},
{0,1,0,0,medium_turn_left_gentle_up_rects+8},{0,1,-32,0,medium_turn_left_gentle_up_rects+9},{0,32,-64,24,medium_turn_left_gentle_up_rects+10},{0,76,-96,16,medium_turn_left_gentle_up_rects+42},{0,65,-128,48,medium_turn_left_gentle_up_rects+118},
{TRACK_MASK_INTERSECT,29,0,0,medium_turn_bank_gentle_up_rects},{0,0,0,0,medium_turn_left_gentle_up_rects+185},{0,29,0,-8,medium_turn_bank_gentle_up_rects+29},{0,0,0,0,medium_turn_left_gentle_up_rects+186},{TRACK_MASK_DIFFERENCE,29,0,-16,medium_turn_bank_gentle_up_rects},
{0,33,0,0,medium_turn_left_gentle_up_rects+188},{0,36,32,32,medium_turn_left_gentle_up_rects+221},{0,43,64,24,medium_turn_left_gentle_up_rects+257},{0,53,96,48,medium_turn_left_gentle_up_rects+300},{0,45,128,48,medium_turn_left_gentle_up_rects+353},
};


mask_t medium_turn_right_bank_gentle_up_masks[]={
{0,33,0,0,medium_turn_right_gentle_up_rects+0},{0,36,-32,32,medium_turn_right_gentle_up_rects+33},{0,43,-64,24,medium_turn_right_gentle_up_rects+69},{0,53,-96,48,medium_turn_right_gentle_up_rects+112},{0,45,-128,48,medium_turn_right_gentle_up_rects+165},
{TRACK_MASK_INTERSECT,29,0,0,medium_turn_bank_gentle_up_rects+58},{0,0,-32,0,medium_turn_right_gentle_up_rects+212},{0,29,0,-8,medium_turn_bank_gentle_up_rects+87},{0,0,-32,-8,medium_turn_right_gentle_up_rects+213},{TRACK_MASK_DIFFERENCE,29,0,-16,medium_turn_bank_gentle_up_rects+58},
{0,1,0,0,medium_turn_right_gentle_up_rects+215},{0,1,32,0,medium_turn_right_gentle_up_rects+216},{0,32,64,24,medium_turn_right_gentle_up_rects+217},{0,76,96,16,medium_turn_right_gentle_up_rects+249},{0,65,128,48,medium_turn_right_gentle_up_rects+325},
{0,2,0,0,medium_turn_right_gentle_up_rects+390},{0,2,32,32,medium_turn_right_gentle_up_rects+392},{0,0,0,56,medium_turn_right_gentle_up_rects+394},{0,2,32,80,medium_turn_right_gentle_up_rects+394},{0,2,0,112,medium_turn_right_gentle_up_rects+396},
};
const track_section_t medium_turn_left_bank_gentle_up={TRACK_BANK_LEFT|TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT,medium_turn_left_bank_gentle_up_curve,MEDIUM_TURN_GENTLE_LENGTH,{{0,5,medium_turn_left_bank_gentle_up_masks},{0,5,medium_turn_left_bank_gentle_up_masks+5},{VIEW_NEEDS_TRACK_MASK,5,medium_turn_left_bank_gentle_up_masks+10},{0,5,medium_turn_left_bank_gentle_up_masks+15}}};


const track_section_t medium_turn_right_bank_gentle_up={TRACK_BANK_RIGHT|TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,medium_turn_right_bank_gentle_up_curve,MEDIUM_TURN_GENTLE_LENGTH,{{0,5,medium_turn_right_bank_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,5,medium_turn_right_bank_gentle_up_masks+5},{0,5,medium_turn_right_bank_gentle_up_masks+10},{0,5,medium_turn_right_bank_gentle_up_masks+15}}};
...
const track_section_t small_helix_left_up={TRACK_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_left_up_curve,SMALL_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,small_helix_left_up_masks},{0,3,small_helix_left_up_masks+4},{VIEW_NEEDS_TRACK_MASK,4,small_helix_left_up_masks+7},{0,3,small_helix_left_up_masks+11}}};
...
const track_section_t small_helix_right_up={TRACK_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_right_up_curve,SMALL_HELIX_LENGTH,{{0,3,small_helix_right_up_masks},{VIEW_NEEDS_TRACK_MASK,4,small_helix_right_up_masks+3},{0,3,small_helix_right_up_masks+7},{VIEW_NEEDS_TRACK_MASK,4,small_helix_right_up_masks+10}}};
...
const track_section_t medium_helix_left_up={TRACK_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,medium_helix_left_up_curve,MEDIUM_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,6,medium_helix_left_up_masks},{0,5,medium_helix_left_up_masks+6},{VIEW_NEEDS_TRACK_MASK,6,medium_helix_left_up_masks+11},{0,5,medium_helix_left_up_masks+17}}};
...
const track_section_t medium_helix_right_up={TRACK_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,medium_helix_right_up_curve,MEDIUM_HELIX_LENGTH,{{0,5,medium_helix_right_up_masks},{VIEW_NEEDS_TRACK_MASK,6,medium_helix_right_up_masks+5},{0,5,medium_helix_right_up_masks+11},{VIEW_NEEDS_TRACK_MASK,6,medium_helix_right_up_masks+16}}};
...
mask_t half_loop_masks[]={
	{TRACK_MASK_NONE,24,-6,-3,half_loop_rects},{TRACK_MASK_NONE,36,-32,32,half_loop_rects+24},{TRACK_MASK_UNION,12,-48,56,half_loop_rects+60},{TRACK_MASK_DIFFERENCE,2,-32,168,half_loop_rects+72},
...
const track_section_t half_loop={TRACK_NO_SUPPORTS|TRACK_SPECIAL_HALF_LOOP|TRACK_EXIT_180_DEG,half_loop_curve,HALF_LOOP_LENGTH,{{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,half_loop_masks},{VIEW_NEEDS_TRACK_MASK,4,half_loop_masks+4},{VIEW_NEEDS_TRACK_MASK,4,half_loop_masks+8},{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,half_loop_masks+12}}};



const track_section_t vertical_loop_left={TRACK_NO_SUPPORTS|TRACK_SPECIAL_HALF_LOOP|TRACK_EXIT_180_DEG,vertical_loop_left_curve,VERTICAL_LOOP_LENGTH,{{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,half_loop_masks},{VIEW_NEEDS_TRACK_MASK,4,half_loop_masks+4},{VIEW_NEEDS_TRACK_MASK,4,half_loop_masks+8},{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,half_loop_masks+12}}};


/*
mask_t vertical_loop_right_masks[]={
	{TRACK_MASK_NONE,24,-6,-3,half_loop_rects},{TRACK_MASK_NONE,36,-32,32,half_loop_rects+24},{TRACK_MASK_UNION,12,-48,56,half_loop_rects+60},{TRACK_MASK_DIFFERENCE,2,-32,168,half_loop_rects+72},
	{TRACK_MASK_UNION,1,6,-3,half_loop_rects+74},{TRACK_MASK_DIFFERENCE,2,-18,-7,half_loop_rects+75},{TRACK_MASK_NONE,2,-76,-6,half_loop_rects+77},{TRACK_MASK_NONE,2,-32,136,half_loop_rects+79},
	{TRACK_MASK_UNION,1,-6,-3,half_loop_rects+81},{TRACK_MASK_DIFFERENCE,2,26,-3,half_loop_rects+82},{TRACK_MASK_NONE,2,58,-13,half_loop_rects+84},{TRACK_MASK_NONE,2,16,96+32,half_loop_rects+86},
	{TRACK_MASK_NONE,24,6,-3,half_loop_rects+88},{TRACK_MASK_NONE,36,38,29,half_loop_rects+112},{TRACK_MASK_UNION,12,64,48,half_loop_rects+148},{TRACK_MASK_DIFFERENCE,2,48,160,half_loop_rects+160}
...
mask_t vertical_loop_right_masks[]={
	{TRACK_MASK_NONE,24,-6,-3,half_loop_rects},{TRACK_MASK_NONE,36,-38,29,half_loop_rects+24},{TRACK_MASK_UNION,12,-64,48,half_loop_rects+60},{TRACK_MASK_DIFFERENCE,2,-48,160,half_loop_rects+72},
	{TRACK_MASK_UNION,1,6,-3,half_loop_rects+74},{TRACK_MASK_DIFFERENCE,2,-26,-3,half_loop_rects+75},{TRACK_MASK_NONE,2,-58,-13,half_loop_rects+77},{TRACK_MASK_NONE,2,-16,128,half_loop_rects+79},
	{TRACK_MASK_UNION,1,-6,-3,half_loop_rects+81},{TRACK_MASK_DIFFERENCE,2,18,-7,half_loop_rects+82},{TRACK_MASK_NONE,2,76,-6,half_loop_rects+84},{TRACK_MASK_NONE,2,32,136,half_loop_rects+86},
	{TRACK_MASK_NONE,24,6,-3,half_loop_rects+88},{TRACK_MASK_NONE,36,32,32,half_loop_rects+112},{TRACK_MASK_UNION,12,48,56,half_loop_rects+148},{TRACK_MASK_DIFFERENCE,2,32,168,half_loop_rects+160}
};

const track_section_t vertical_loop_right={TRACK_NO_SUPPORTS|TRACK_SPECIAL_HALF_LOOP|TRACK_EXIT_180_DEG,vertical_loop_right_curve,VERTICAL_LOOP_LENGTH,{{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,vertical_loop_right_masks},{VIEW_NEEDS_TRACK_MASK,4,vertical_loop_right_masks+4},{VIEW_NEEDS_TRACK_MASK,4,vertical_loop_right_masks+8},{VIEW_NEEDS_TRACK_MASK|VIEW_ENFORCE_NON_OVERLAPPING,4,vertical_loop_right_masks+12}}};
...
const track_section_t flat_to_steep_up={TRACK_OFFSET_SPRITE_MASK|TRACK_ALT_PREFER_ODD,flat_to_steep_up_curve,FLAT_TO_STEEP_LENGTH,{{0,4,flat_to_steep_up_masks},{0,4,flat_to_steep_up_masks+4},{0,4,flat_to_steep_up_masks+8},{0,4,flat_to_steep_up_masks+12}}};
...
const track_section_t steep_to_flat_up={TRACK_OFFSET_SPRITE_MASK|TRACK_ALT_INVERT|TRACK_ALT_PREFER_ODD,steep_to_flat_up_curve,FLAT_TO_STEEP_LENGTH,{{0,4,steep_to_flat_up_masks},{0,4,steep_to_flat_up_masks+4},{0,4,steep_to_flat_up_masks+8},{0,4,steep_to_flat_up_masks+12}}};
...
const track_section_t quarter_loop_up={TRACK_VERTICAL|TRACK_NO_SUPPORTS|TRACK_SPECIAL_QUARTER_LOOP|TRACK_EXIT_180_DEG,quarter_loop_up_curve,QUARTER_LOOP_LENGTH,{{0,3,quarter_loop_up_masks},{0,3,quarter_loop_up_masks+3},{0,3,quarter_loop_up_masks+6},{0,3,quarter_loop_up_masks+9}}};
...
const track_section_t semi_split_small_helix_left_up={TRACK_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_left_up_curve,SMALL_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,semi_split_small_helix_left_up_masks},{VIEW_NEEDS_TRACK_MASK,5,semi_split_small_helix_left_up_masks+4},{VIEW_NEEDS_TRACK_MASK,4,semi_split_small_helix_left_up_masks+9},{0,3,semi_split_small_helix_left_up_masks+13}}};
...
const track_section_t semi_split_small_helix_right_up={TRACK_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_right_up_curve,SMALL_HELIX_LENGTH,{{0,3,semi_split_small_helix_right_up_masks},{VIEW_NEEDS_TRACK_MASK,4,semi_split_small_helix_right_up_masks+3},{VIEW_NEEDS_TRACK_MASK,5,semi_split_small_helix_right_up_masks+7},{VIEW_NEEDS_TRACK_MASK,4,semi_split_small_helix_right_up_masks+12}}};
...
mask_t semi_split_zero_g_roll_left_masks[]={
{TRACK_MASK_INTERSECT,25,0,0,zero_g_roll_left_rects+0},{TRACK_MASK_DIFFERENCE,25,0,0,zero_g_roll_left_rects+0},{TRACK_MASK_INTERSECT,57,-32,24,zero_g_roll_left_rects+25},{TRACK_MASK_DIFFERENCE,57,-32,24,zero_g_roll_left_rects+25},{TRACK_MASK_INTERSECT,32,-64,56,zero_g_roll_left_rects+82},{TRACK_MASK_DIFFERENCE,32,-64,56,zero_g_roll_left_rects+82},
{TRACK_MASK_INTERSECT,1,0,0,zero_g_roll_left_rects+114},{TRACK_MASK_DIFFERENCE,1,0,0,zero_g_roll_left_rects+114},{TRACK_MASK_INTERSECT,1,-32,-8,zero_g_roll_left_rects+115},{TRACK_MASK_DIFFERENCE,1,-32,-8,zero_g_roll_left_rects+115},{TRACK_MASK_INTERSECT,1,-64,-8,zero_g_roll_left_rects+116},{TRACK_MASK_DIFFERENCE,1,-64,-8,zero_g_roll_left_rects+116},
{0,18,0,0,zero_g_roll_left_rects+117},{0,28,32,-8,zero_g_roll_left_rects+135},{TRACK_MASK_INTERSECT,14,64,-8,zero_g_roll_left_rects+163},{TRACK_MASK_DIFFERENCE,14,64,-8,zero_g_roll_left_rects+163},
{0,34,0,0,zero_g_roll_left_rects+177},{0,52,32,24,zero_g_roll_left_rects+211},{TRACK_MASK_INTERSECT,20,64,56,zero_g_roll_left_rects+263},{TRACK_MASK_DIFFERENCE,20,64,56,zero_g_roll_left_rects+263},
};
mask_t semi_split_zero_g_roll_right_masks[]={
{0,34,0,0,zero_g_roll_right_rects+0},{0,52,-32,24,zero_g_roll_right_rects+34},{TRACK_MASK_INTERSECT,20,-64,56,zero_g_roll_right_rects+86},{TRACK_MASK_DIFFERENCE,20,-64,56,zero_g_roll_right_rects+86},
{0,18,0,0,zero_g_roll_right_rects+106},{0,28,-32,-8,zero_g_roll_right_rects+124},{TRACK_MASK_INTERSECT,14,-64,-8,zero_g_roll_right_rects+152},{TRACK_MASK_DIFFERENCE,14,-64,-8,zero_g_roll_right_rects+152},
{TRACK_MASK_INTERSECT,1,0,0,zero_g_roll_right_rects+166},{TRACK_MASK_DIFFERENCE,1,0,0,zero_g_roll_right_rects+166},{TRACK_MASK_INTERSECT,1,32,-8,zero_g_roll_right_rects+167},{TRACK_MASK_DIFFERENCE,1,32,-8,zero_g_roll_right_rects+167},{TRACK_MASK_INTERSECT,1,64,-8,zero_g_roll_right_rects+168},{TRACK_MASK_DIFFERENCE,1,64,-8,zero_g_roll_right_rects+168},
{TRACK_MASK_INTERSECT,25,0,0,zero_g_roll_right_rects+169},{TRACK_MASK_DIFFERENCE,25,0,0,zero_g_roll_right_rects+169},{TRACK_MASK_INTERSECT,57,32,24,zero_g_roll_right_rects+194},{TRACK_MASK_DIFFERENCE,57,32,24,zero_g_roll_right_rects+194},{TRACK_MASK_INTERSECT,32,64,56,zero_g_roll_right_rects+251},{TRACK_MASK_DIFFERENCE,32,64,56,zero_g_roll_right_rects+251},
};
const track_section_t semi_split_zero_g_roll_left={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_ZERO_G_ROLL_LEFT,zero_g_roll_left_curve,ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,6,semi_split_zero_g_roll_left_masks},{VIEW_NEEDS_TRACK_MASK,6,semi_split_zero_g_roll_left_masks+6},{VIEW_NEEDS_TRACK_MASK,4,semi_split_zero_g_roll_left_masks+12},{VIEW_NEEDS_TRACK_MASK,4,semi_split_zero_g_roll_left_masks+16}}};
const track_section_t semi_split_zero_g_roll_right={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_ZERO_G_ROLL_RIGHT,zero_g_roll_right_curve,ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,semi_split_zero_g_roll_right_masks},{VIEW_NEEDS_TRACK_MASK,4,semi_split_zero_g_roll_right_masks+4},{VIEW_NEEDS_TRACK_MASK,6,semi_split_zero_g_roll_right_masks+8},{VIEW_NEEDS_TRACK_MASK,6,semi_split_zero_g_roll_right_masks+14}}};
mask_t semi_split_large_zero_g_roll_left_masks[]={
{0,18,0,0,large_zero_g_roll_left_rects+0},
{TRACK_MASK_INTERSECT,34,-32,72,large_zero_g_roll_left_rects+18},{TRACK_MASK_DIFFERENCE,34,-32,72,large_zero_g_roll_left_rects+18},
{TRACK_MASK_INTERSECT,49,-64,128,large_zero_g_roll_left_rects+52},{TRACK_MASK_DIFFERENCE,49,-64,128,large_zero_g_roll_left_rects+52},
{TRACK_MASK_INTERSECT,33,-96,168,large_zero_g_roll_left_rects+101},{TRACK_MASK_DIFFERENCE,33,-96,168,large_zero_g_roll_left_rects+101},


{TRACK_MASK_INTERSECT,49,0,0,large_zero_g_roll_left_rects+134},{TRACK_MASK_DIFFERENCE,49,0,0,large_zero_g_roll_left_rects+134},
{TRACK_MASK_INTERSECT,54,-32,40,large_zero_g_roll_left_rects+183},{TRACK_MASK_DIFFERENCE,54,-32,40,large_zero_g_roll_left_rects+183},
{TRACK_MASK_INTERSECT,28,-64,64,large_zero_g_roll_left_rects+237},{TRACK_MASK_DIFFERENCE,28,-64,64,large_zero_g_roll_left_rects+237},
{TRACK_MASK_INTERSECT,5,-96,72,large_zero_g_roll_left_rects+265},{TRACK_MASK_DIFFERENCE,5,-96,72,large_zero_g_roll_left_rects+265},

{TRACK_MASK_INTERSECT,33,0,0,large_zero_g_roll_left_rects+270},{TRACK_MASK_DIFFERENCE,33,0,0,large_zero_g_roll_left_rects+270},
{TRACK_MASK_INTERSECT,65,32,40,large_zero_g_roll_left_rects+303},{TRACK_MASK_DIFFERENCE,65,32,40,large_zero_g_roll_left_rects+303},
{TRACK_MASK_INTERSECT,33,64,64,large_zero_g_roll_left_rects+368},{TRACK_MASK_DIFFERENCE,33,64,64,large_zero_g_roll_left_rects+368},
{TRACK_MASK_INTERSECT,1,96,72,large_zero_g_roll_left_rects+401},{TRACK_MASK_DIFFERENCE,1,96,72,large_zero_g_roll_left_rects+401},

{0,17,0,0,large_zero_g_roll_left_rects+402},
{0,33,32,72,large_zero_g_roll_left_rects+419},
{TRACK_MASK_INTERSECT,49,64,128,large_zero_g_roll_left_rects+452},{TRACK_MASK_DIFFERENCE,49,64,128,large_zero_g_roll_left_rects+452},
{TRACK_MASK_INTERSECT,33,96,168,large_zero_g_roll_left_rects+501},{TRACK_MASK_DIFFERENCE,33,96,168,large_zero_g_roll_left_rects+501},
};
mask_t semi_split_large_zero_g_roll_right_masks[]={
{0,17,0,0,large_zero_g_roll_right_rects+0},
{0,33,-32,72,large_zero_g_roll_right_rects+17},
{TRACK_MASK_INTERSECT,49,-64,128,large_zero_g_roll_right_rects+50},{TRACK_MASK_DIFFERENCE,49,-64,128,large_zero_g_roll_right_rects+50},
{TRACK_MASK_INTERSECT,33,-96,168,large_zero_g_roll_right_rects+99},{TRACK_MASK_DIFFERENCE,33,-96,168,large_zero_g_roll_right_rects+99},

{TRACK_MASK_INTERSECT,33,0,0,large_zero_g_roll_right_rects+132},{TRACK_MASK_DIFFERENCE,33,0,0,large_zero_g_roll_right_rects+132},
{TRACK_MASK_INTERSECT,65,-32,40,large_zero_g_roll_right_rects+165},{TRACK_MASK_DIFFERENCE,65,-32,40,large_zero_g_roll_right_rects+165},
{TRACK_MASK_INTERSECT,33,-64,64,large_zero_g_roll_right_rects+230},{TRACK_MASK_DIFFERENCE,33,-64,64,large_zero_g_roll_right_rects+230},
{TRACK_MASK_INTERSECT,1,-96,72,large_zero_g_roll_right_rects+263},{TRACK_MASK_DIFFERENCE,1,-96,72,large_zero_g_roll_right_rects+263},

{TRACK_MASK_INTERSECT,49,0,0,large_zero_g_roll_right_rects+264},   {TRACK_MASK_DIFFERENCE,49,0,0,large_zero_g_roll_right_rects+264},
{TRACK_MASK_INTERSECT,54,32,40,large_zero_g_roll_right_rects+313}, {TRACK_MASK_DIFFERENCE,54,32,40,large_zero_g_roll_right_rects+313},
{TRACK_MASK_INTERSECT,28,64,64,large_zero_g_roll_right_rects+367},{TRACK_MASK_DIFFERENCE,28,64,64,large_zero_g_roll_right_rects+367},
{TRACK_MASK_INTERSECT,5,96,72,large_zero_g_roll_right_rects+395}, {TRACK_MASK_DIFFERENCE,5,96,72,large_zero_g_roll_right_rects+395},

{0,18,0,0,large_zero_g_roll_right_rects+400},
{TRACK_MASK_INTERSECT,34,32,72,large_zero_g_roll_right_rects+418},{TRACK_MASK_DIFFERENCE,34,32,72,large_zero_g_roll_right_rects+418},
{TRACK_MASK_INTERSECT,49,64,128,large_zero_g_roll_right_rects+452},{TRACK_MASK_DIFFERENCE,49,64,128,large_zero_g_roll_right_rects+452},
{TRACK_MASK_INTERSECT,33,96,168,large_zero_g_roll_right_rects+501},{TRACK_MASK_DIFFERENCE,33,96,168,large_zero_g_roll_right_rects+501},
};
const track_section_t semi_split_large_zero_g_roll_left={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_LARGE_ZERO_G_ROLL_LEFT,large_zero_g_roll_left_curve,LARGE_ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,7,semi_split_large_zero_g_roll_left_masks},{0,8,semi_split_large_zero_g_roll_left_masks+7},{VIEW_NEEDS_TRACK_MASK,8,semi_split_large_zero_g_roll_left_masks+15},{VIEW_NEEDS_TRACK_MASK,6,semi_split_large_zero_g_roll_left_masks+23}}};
const track_section_t semi_split_large_zero_g_roll_right={TRACK_NO_SUPPORTS|TRACK_OFFSET_SPRITE_MASK|TRACK_SPECIAL_LARGE_ZERO_G_ROLL_RIGHT,large_zero_g_roll_right_curve,LARGE_ZERO_G_ROLL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,6,semi_split_large_zero_g_roll_right_masks},{VIEW_NEEDS_TRACK_MASK,8,semi_split_large_zero_g_roll_right_masks+6},{0,8,semi_split_large_zero_g_roll_right_masks+14},{VIEW_NEEDS_TRACK_MASK,7,semi_split_large_zero_g_roll_right_masks+22}}};



const track_section_t semi_split_left_bank_to_gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_LEFT,left_bank_to_gentle_up_left_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t semi_split_right_bank_to_gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_RIGHT,right_bank_to_gentle_up_right_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};
const track_section_t semi_split_gentle_up_left_bank_to_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_BANK_LEFT,gentle_up_left_bank_to_left_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t semi_split_gentle_up_right_bank_to_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_BANK_RIGHT,gentle_up_right_bank_to_right_bank_diag_curve,FLAT_TO_GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};
const track_section_t semi_split_gentle_up_left_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_LEFT,gentle_up_left_bank_diag_curve,GENTLE_DIAG_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{0,1,&diag_slope_mask}}};
const track_section_t semi_split_gentle_up_right_bank_diag={TRACK_DIAGONAL|TRACK_SUPPORT_BASE|TRACK_EXTRUDE_BEHIND|TRACK_EXTRUDE_IN_FRONT|TRACK_BANK_RIGHT,gentle_up_right_bank_diag_curve,GENTLE_DIAG_LENGTH,{{0,1,&diag_slope_mask},{0,1,&diag_slope_mask},{VIEW_NEEDS_TRACK_MASK,2,diagonal_transition_masks},{0,1,&diag_slope_mask}}};


mask_t semi_split_large_turn_left_to_orthogonal_gentle_up_masks[]={
{TRACK_MASK_INTERSECT,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+0},{TRACK_MASK_DIFFERENCE,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+0},{TRACK_MASK_INTERSECT,0,-32,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{TRACK_MASK_DIFFERENCE,0,-32,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{TRACK_MASK_INTERSECT,17,-64,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{TRACK_MASK_DIFFERENCE,17,-64,16,large_turn_left_to_orthogonal_gentle_up_rects+1},{TRACK_MASK_INTERSECT,17,-96,48,large_turn_left_to_orthogonal_gentle_up_rects+18},{TRACK_MASK_DIFFERENCE,17,-96,48,large_turn_left_to_orthogonal_gentle_up_rects+18},
{0,17,0,0,large_turn_left_to_orthogonal_gentle_up_rects+35},{0,0,-32,-16,large_turn_left_to_orthogonal_gentle_up_rects+52},{0,26,0,-16,large_turn_left_to_orthogonal_gentle_up_rects+52},{0,10,-32,-16,large_turn_left_to_orthogonal_gentle_up_rects+78},
{0,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+88},{0,0,32,-16,large_turn_left_to_orthogonal_gentle_up_rects+89},{0,33,64,16,large_turn_left_to_orthogonal_gentle_up_rects+89},{0,33,96,16,large_turn_left_to_orthogonal_gentle_up_rects+122},
{0,1,0,0,large_turn_left_to_orthogonal_gentle_up_rects+155},{0,1,32,16,large_turn_left_to_orthogonal_gentle_up_rects+156},{0,18,0,48,large_turn_left_to_orthogonal_gentle_up_rects+157},{0,18,32,80,large_turn_left_to_orthogonal_gentle_up_rects+175},
};

const track_section_t semi_split_large_turn_left_bank_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_BANK_LEFT,large_turn_left_bank_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{VIEW_NEEDS_TRACK_MASK,8,semi_split_large_turn_left_to_orthogonal_gentle_up_masks},{0,4,semi_split_large_turn_left_to_orthogonal_gentle_up_masks + 8},{0,4,semi_split_large_turn_left_to_orthogonal_gentle_up_masks + 12},{0,4,semi_split_large_turn_left_to_orthogonal_gentle_up_masks + 16}}};

mask_t semi_split_large_turn_right_to_orthogonal_gentle_up_masks[]={
{0,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+0},{0,0,-32,-16,large_turn_right_to_orthogonal_gentle_up_rects+1},{0,33,-64,16,large_turn_right_to_orthogonal_gentle_up_rects+1},{0,33,-96,16,large_turn_right_to_orthogonal_gentle_up_rects+34},
{0,17,0,0,large_turn_right_to_orthogonal_gentle_up_rects+67},{0,0,32,-16,large_turn_right_to_orthogonal_gentle_up_rects+84},{0,26,0,-16,large_turn_right_to_orthogonal_gentle_up_rects+84},{0,10,32,-16,large_turn_right_to_orthogonal_gentle_up_rects+110},
{TRACK_MASK_INTERSECT,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+120},{TRACK_MASK_DIFFERENCE,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+120},{TRACK_MASK_INTERSECT,0,32,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{TRACK_MASK_DIFFERENCE,0,32,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{TRACK_MASK_INTERSECT,17,64,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{TRACK_MASK_DIFFERENCE,17,64,16,large_turn_right_to_orthogonal_gentle_up_rects+121},{TRACK_MASK_INTERSECT,17,96,48,large_turn_right_to_orthogonal_gentle_up_rects+138},{TRACK_MASK_DIFFERENCE,17,96,48,large_turn_right_to_orthogonal_gentle_up_rects+138},
{0,1,0,0,large_turn_right_to_orthogonal_gentle_up_rects+155},{0,1,-32,16,large_turn_right_to_orthogonal_gentle_up_rects+156},{0,18,0,48,large_turn_right_to_orthogonal_gentle_up_rects+157},{0,18,-32,80,large_turn_right_to_orthogonal_gentle_up_rects+175},
};

const track_section_t semi_split_large_turn_right_bank_to_orthogonal_gentle_up={TRACK_DIAGONAL_2|TRACK_EXTRUDE_BEHIND|TRACK_EXIT_90_DEG_LEFT|TRACK_BANK_RIGHT,large_turn_right_bank_to_orthogonal_gentle_up_curve,LARGE_TURN_GENTLE_LENGTH,{{0,4,semi_split_large_turn_right_to_orthogonal_gentle_up_masks},{0,4,semi_split_large_turn_right_to_orthogonal_gentle_up_masks + 4},{VIEW_NEEDS_TRACK_MASK,8,semi_split_large_turn_right_to_orthogonal_gentle_up_masks + 8},{0,4,semi_split_large_turn_right_to_orthogonal_gentle_up_masks + 16}}};
...
mask_t split_small_turn_left_gentle_up_masks[]={
{TRACK_MASK_INTERSECT,1,-6,-3,small_turn_left_gentle_up_rects}  ,{TRACK_MASK_DIFFERENCE,1,-6,-3,small_turn_left_gentle_up_rects}  ,{TRACK_MASK_INTERSECT,1,6,45,small_turn_left_gentle_up_rects+1}  ,{TRACK_MASK_DIFFERENCE,1,6,45,small_turn_left_gentle_up_rects+1},  
{TRACK_MASK_INTERSECT,1,6,-3,small_turn_left_gentle_up_rects+2} ,{TRACK_MASK_DIFFERENCE,1,6,-3,small_turn_left_gentle_up_rects+2} ,{TRACK_MASK_INTERSECT,1,-70,13,small_turn_left_gentle_up_rects+3},{TRACK_MASK_DIFFERENCE,1,-70,13,small_turn_left_gentle_up_rects+3},
{TRACK_MASK_INTERSECT,1,-6,-3,small_turn_left_gentle_up_rects+4},{TRACK_MASK_DIFFERENCE,1,-6,-3,small_turn_left_gentle_up_rects+4},{TRACK_MASK_INTERSECT,1,6,-19,small_turn_left_gentle_up_rects+5} ,{TRACK_MASK_DIFFERENCE,1,6,-19,small_turn_left_gentle_up_rects+5}, 
{TRACK_MASK_INTERSECT,1,6,-3,small_turn_left_gentle_up_rects+6} ,{TRACK_MASK_DIFFERENCE,1,6,-3,small_turn_left_gentle_up_rects+6} ,{TRACK_MASK_INTERSECT,1,58,13,small_turn_left_gentle_up_rects+7} ,{TRACK_MASK_DIFFERENCE,1,58,13,small_turn_left_gentle_up_rects+7}  
};
const track_section_t split_small_turn_left_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT,small_turn_left_gentle_up_curve,SMALL_TURN_GENTLE_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_left_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_left_gentle_up_masks+4},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_left_gentle_up_masks+8},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_left_gentle_up_masks+12}}};

mask_t split_small_turn_right_gentle_up_masks[]={
{TRACK_MASK_INTERSECT,1,-6,-3,small_turn_right_gentle_up_rects}  ,{TRACK_MASK_DIFFERENCE,1,-6,-3,small_turn_right_gentle_up_rects}  ,{TRACK_MASK_INTERSECT,1,-58,13,small_turn_right_gentle_up_rects+1},{TRACK_MASK_DIFFERENCE,1,-58,13,small_turn_right_gentle_up_rects+1},
{TRACK_MASK_INTERSECT,1,6,-3,small_turn_right_gentle_up_rects+2} ,{TRACK_MASK_DIFFERENCE,1,6,-3,small_turn_right_gentle_up_rects+2} ,{TRACK_MASK_INTERSECT,1,-6,-19,small_turn_right_gentle_up_rects+3},{TRACK_MASK_DIFFERENCE,1,-6,-19,small_turn_right_gentle_up_rects+3},
{TRACK_MASK_INTERSECT,1,-6,-3,small_turn_right_gentle_up_rects+4},{TRACK_MASK_DIFFERENCE,1,-6,-3,small_turn_right_gentle_up_rects+4},{TRACK_MASK_INTERSECT,1,70,13,small_turn_right_gentle_up_rects+5} ,{TRACK_MASK_DIFFERENCE,1,70,13,small_turn_right_gentle_up_rects+5},
{TRACK_MASK_INTERSECT,1,6,-3,small_turn_right_gentle_up_rects+6} ,{TRACK_MASK_DIFFERENCE,1,6,-3,small_turn_right_gentle_up_rects+6} ,{TRACK_MASK_INTERSECT,1,-6,45,small_turn_right_gentle_up_rects+7} ,{TRACK_MASK_DIFFERENCE,1,-6,45,small_turn_right_gentle_up_rects+7} 
};
const track_section_t split_small_turn_right_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,small_turn_right_gentle_up_curve,SMALL_TURN_GENTLE_LENGTH,{{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_right_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_right_gentle_up_masks+4},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_right_gentle_up_masks+8},{VIEW_NEEDS_TRACK_MASK,4,split_small_turn_right_gentle_up_masks+12}}};



mask_t split_medium_turn_left_gentle_up_masks[]={
{TRACK_MASK_INTERSECT,2,0,0,medium_turn_left_gentle_up_rects+0}   ,{TRACK_MASK_DIFFERENCE,2,0,0,medium_turn_left_gentle_up_rects+0}   ,{TRACK_MASK_INTERSECT,2,-32,32,medium_turn_left_gentle_up_rects+2}  ,{TRACK_MASK_DIFFERENCE,2,-32,32,medium_turn_left_gentle_up_rects+2}  ,{TRACK_MASK_INTERSECT,0,0,0,medium_turn_left_gentle_up_rects+4}     ,{TRACK_MASK_DIFFERENCE,0,0,0,medium_turn_left_gentle_up_rects+4}     ,{TRACK_MASK_INTERSECT,2,-32,80,medium_turn_left_gentle_up_rects+4}  ,{TRACK_MASK_DIFFERENCE,2,-32,80,medium_turn_left_gentle_up_rects+4}  ,{TRACK_MASK_INTERSECT,2,0,112,medium_turn_left_gentle_up_rects+6}    , {TRACK_MASK_DIFFERENCE,2,0,112,medium_turn_left_gentle_up_rects+6},
{TRACK_MASK_INTERSECT,1,0,0,medium_turn_left_gentle_up_rects+8}   ,{TRACK_MASK_DIFFERENCE,1,0,0,medium_turn_left_gentle_up_rects+8}   ,{TRACK_MASK_INTERSECT,1,-32,0,medium_turn_left_gentle_up_rects+9}   ,{TRACK_MASK_DIFFERENCE,1,-32,0,medium_turn_left_gentle_up_rects+9}   ,{TRACK_MASK_INTERSECT,32,-64,24,medium_turn_left_gentle_up_rects+10},{TRACK_MASK_DIFFERENCE,32,-64,24,medium_turn_left_gentle_up_rects+10},{TRACK_MASK_INTERSECT,76,-96,16,medium_turn_left_gentle_up_rects+42},{TRACK_MASK_DIFFERENCE,76,-96,16,medium_turn_left_gentle_up_rects+42},{TRACK_MASK_INTERSECT,65,-128,48,medium_turn_left_gentle_up_rects+118},{TRACK_MASK_DIFFERENCE,65,-128,48,medium_turn_left_gentle_up_rects+118},
{TRACK_MASK_INTERSECT,2,0,0,medium_turn_left_gentle_up_rects+183} ,{TRACK_MASK_DIFFERENCE,2,0,0,medium_turn_left_gentle_up_rects+183} ,{TRACK_MASK_INTERSECT,0,0,0,medium_turn_left_gentle_up_rects+185}   ,{TRACK_MASK_DIFFERENCE,0,0,0,medium_turn_left_gentle_up_rects+185}   ,{TRACK_MASK_INTERSECT,1,0,-8,medium_turn_left_gentle_up_rects+185}  ,{TRACK_MASK_DIFFERENCE,1,0,-8,medium_turn_left_gentle_up_rects+185}  ,{TRACK_MASK_INTERSECT,0,0,0,medium_turn_left_gentle_up_rects+186}   ,{TRACK_MASK_DIFFERENCE,0,0,0,medium_turn_left_gentle_up_rects+186}   ,{TRACK_MASK_INTERSECT,2,0,-16,medium_turn_left_gentle_up_rects+186}   ,{TRACK_MASK_DIFFERENCE,2,0,-16,medium_turn_left_gentle_up_rects+186},
{TRACK_MASK_INTERSECT,33,0,0,medium_turn_left_gentle_up_rects+188},{TRACK_MASK_DIFFERENCE,33,0,0,medium_turn_left_gentle_up_rects+188},{TRACK_MASK_INTERSECT,36,32,32,medium_turn_left_gentle_up_rects+221},{TRACK_MASK_DIFFERENCE,36,32,32,medium_turn_left_gentle_up_rects+221},{TRACK_MASK_INTERSECT,43,64,24,medium_turn_left_gentle_up_rects+257},{TRACK_MASK_DIFFERENCE,43,64,24,medium_turn_left_gentle_up_rects+257},{TRACK_MASK_INTERSECT,53,96,48,medium_turn_left_gentle_up_rects+300},{TRACK_MASK_DIFFERENCE,53,96,48,medium_turn_left_gentle_up_rects+300},{TRACK_MASK_INTERSECT,45,128,48,medium_turn_left_gentle_up_rects+353} ,{TRACK_MASK_DIFFERENCE,45,128,48,medium_turn_left_gentle_up_rects+353},
};

const track_section_t split_medium_turn_left_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT,medium_turn_left_gentle_up_curve,MEDIUM_TURN_GENTLE_LENGTH,{{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_gentle_up_masks+10},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_gentle_up_masks+20},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_gentle_up_masks+30}}};

mask_t split_medium_turn_right_gentle_up_masks[]={
{TRACK_MASK_INTERSECT,33,0,0,medium_turn_right_gentle_up_rects+0} ,{TRACK_MASK_DIFFERENCE,33,0,0,medium_turn_right_gentle_up_rects+0} ,{TRACK_MASK_INTERSECT,36,-32,32,medium_turn_right_gentle_up_rects+33},{TRACK_MASK_DIFFERENCE,36,-32,32,medium_turn_right_gentle_up_rects+33},{TRACK_MASK_INTERSECT,43,-64,24,medium_turn_right_gentle_up_rects+69},{TRACK_MASK_DIFFERENCE,43,-64,24,medium_turn_right_gentle_up_rects+69},{TRACK_MASK_INTERSECT,53,-96,48,medium_turn_right_gentle_up_rects+112},{TRACK_MASK_DIFFERENCE,53,-96,48,medium_turn_right_gentle_up_rects+112},{TRACK_MASK_INTERSECT,45,-128,48,medium_turn_right_gentle_up_rects+165},{TRACK_MASK_DIFFERENCE,45,-128,48,medium_turn_right_gentle_up_rects+165},
{TRACK_MASK_INTERSECT,2,0,0,medium_turn_right_gentle_up_rects+210},{TRACK_MASK_DIFFERENCE,2,0,0,medium_turn_right_gentle_up_rects+210},{TRACK_MASK_INTERSECT,0,-32,0,medium_turn_right_gentle_up_rects+212} ,{TRACK_MASK_DIFFERENCE,0,-32,0,medium_turn_right_gentle_up_rects+212} ,{TRACK_MASK_INTERSECT,1,0,-8,medium_turn_right_gentle_up_rects+212}  ,{TRACK_MASK_DIFFERENCE,1,0,-8,medium_turn_right_gentle_up_rects+212}  ,{TRACK_MASK_INTERSECT,0,-32,-8,medium_turn_right_gentle_up_rects+213} ,{TRACK_MASK_DIFFERENCE,0,-32,-8,medium_turn_right_gentle_up_rects+213} ,{TRACK_MASK_INTERSECT,2,0,-16,medium_turn_right_gentle_up_rects+213}   ,{TRACK_MASK_DIFFERENCE,2,0,-16,medium_turn_right_gentle_up_rects+213},
{TRACK_MASK_INTERSECT,1,0,0,medium_turn_right_gentle_up_rects+215},{TRACK_MASK_DIFFERENCE,1,0,0,medium_turn_right_gentle_up_rects+215},{TRACK_MASK_INTERSECT,1,32,0,medium_turn_right_gentle_up_rects+216}  ,{TRACK_MASK_DIFFERENCE,1,32,0,medium_turn_right_gentle_up_rects+216}  ,{TRACK_MASK_INTERSECT,32,64,24,medium_turn_right_gentle_up_rects+217},{TRACK_MASK_DIFFERENCE,32,64,24,medium_turn_right_gentle_up_rects+217},{TRACK_MASK_INTERSECT,76,96,16,medium_turn_right_gentle_up_rects+249} ,{TRACK_MASK_DIFFERENCE,76,96,16,medium_turn_right_gentle_up_rects+249} ,{TRACK_MASK_INTERSECT,65,128,48,medium_turn_right_gentle_up_rects+325} ,{TRACK_MASK_DIFFERENCE,65,128,48,medium_turn_right_gentle_up_rects+325},
{TRACK_MASK_INTERSECT,2,0,0,medium_turn_right_gentle_up_rects+390},{TRACK_MASK_DIFFERENCE,2,0,0,medium_turn_right_gentle_up_rects+390},{TRACK_MASK_INTERSECT,2,32,32,medium_turn_right_gentle_up_rects+392} ,{TRACK_MASK_DIFFERENCE,2,32,32,medium_turn_right_gentle_up_rects+392} ,{TRACK_MASK_INTERSECT,0,0,56,medium_turn_right_gentle_up_rects+394}  ,{TRACK_MASK_DIFFERENCE,0,0,56,medium_turn_right_gentle_up_rects+394}  ,{TRACK_MASK_INTERSECT,2,32,80,medium_turn_right_gentle_up_rects+394}  ,{TRACK_MASK_DIFFERENCE,2,32,80,medium_turn_right_gentle_up_rects+394}  ,{TRACK_MASK_INTERSECT,2,0,112,medium_turn_right_gentle_up_rects+396}   ,{TRACK_MASK_DIFFERENCE,2,0,112,medium_turn_right_gentle_up_rects+396},   
};



const track_section_t split_medium_turn_right_gentle_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT,medium_turn_right_gentle_up_curve,MEDIUM_TURN_GENTLE_LENGTH,{{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_gentle_up_masks},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_gentle_up_masks+10},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_gentle_up_masks+20},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_gentle_up_masks+30}}};

const track_section_t split_very_small_turn_left_steep_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_LEFT|TRACK_ALT_INVERT,very_small_turn_left_steep_up_curve,VERY_SMALL_TURN_STEEP_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks}}};
const track_section_t split_very_small_turn_right_steep_up={TRACK_OFFSET_SPRITE_MASK|TRACK_SUPPORT_BASE|TRACK_EXIT_90_DEG_RIGHT|TRACK_ALT_INVERT,very_small_turn_right_steep_up_curve,VERY_SMALL_TURN_STEEP_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks}}};
...
const track_section_t split_small_helix_left_up={TRACK_OFFSET_SPRITE_MASK|TRACK_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_left_up_curve,SMALL_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_masks},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_masks+6},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_masks+12},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_masks+18}}};
mask_t split_small_turn_right_masks[]={
	{TRACK_MASK_INTERSECT,4,0,0,small_turn_right_rects}    ,{TRACK_MASK_DIFFERENCE,4,0,0,small_turn_right_rects}    ,{TRACK_MASK_INTERSECT,3,-32,16,small_turn_right_rects+4}   ,{TRACK_MASK_DIFFERENCE,3,-32,16,small_turn_right_rects+4}   ,{TRACK_MASK_INTERSECT,4,-64,0,small_turn_right_rects+7}, {TRACK_MASK_DIFFERENCE,4,-64,0,small_turn_right_rects+7},
	{TRACK_MASK_INTERSECT,19,0,0,small_turn_right_rects+11},{TRACK_MASK_DIFFERENCE,19,0,0,small_turn_right_rects+11},{TRACK_MASK_INTERSECT,10,-32,-16,small_turn_right_rects+30},{TRACK_MASK_DIFFERENCE,10,-32,-16,small_turn_right_rects+30},{TRACK_MASK_INTERSECT,9,0,-32,small_turn_right_rects+40},{TRACK_MASK_DIFFERENCE,9,0,-32,small_turn_right_rects+40},
	{TRACK_MASK_INTERSECT,9,0,0,small_turn_right_rects+49} ,{TRACK_MASK_DIFFERENCE,9,0,0,small_turn_right_rects+49} ,{TRACK_MASK_INTERSECT,8,32,-16,small_turn_right_rects+58}  ,{TRACK_MASK_DIFFERENCE,8,32,-16,small_turn_right_rects+58}  ,{TRACK_MASK_INTERSECT,9,64,0,small_turn_right_rects+66}, {TRACK_MASK_DIFFERENCE,9,64,0,small_turn_right_rects+66},
	{TRACK_MASK_INTERSECT,10,0,0,small_turn_right_rects+75},{TRACK_MASK_DIFFERENCE,10,0,0,small_turn_right_rects+75},{TRACK_MASK_INTERSECT,10,32,16,small_turn_right_rects+85}  ,{TRACK_MASK_DIFFERENCE,10,32,16,small_turn_right_rects+85}  ,{TRACK_MASK_INTERSECT,20,0,32,small_turn_right_rects+95},{TRACK_MASK_DIFFERENCE,20,0,32,small_turn_right_rects+95}
};

const track_section_t split_small_helix_right_up={TRACK_OFFSET_SPRITE_MASK|TRACK_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,small_helix_right_up_curve,SMALL_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_right_masks},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_right_masks+6},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_right_masks+12},{VIEW_NEEDS_TRACK_MASK,6,split_small_turn_right_masks+18}}};

const track_section_t split_medium_helix_left_up={TRACK_OFFSET_SPRITE_MASK|TRACK_BANK_LEFT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,medium_helix_left_up_curve,MEDIUM_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_masks},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_masks+10},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_masks+20},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_left_masks+30}}};

mask_t split_medium_turn_right_masks[]={
{TRACK_MASK_INTERSECT,33,0,0,medium_turn_right_rects}    ,{TRACK_MASK_DIFFERENCE,33,0,0,medium_turn_right_rects}    ,{TRACK_MASK_INTERSECT,31,-32,16,medium_turn_right_rects+33}  ,{TRACK_MASK_DIFFERENCE,31,-32,16,medium_turn_right_rects+33}  ,{TRACK_MASK_INTERSECT,32,-64,0,medium_turn_right_rects+64} ,{TRACK_MASK_DIFFERENCE,32,-64,0,medium_turn_right_rects+64} ,{TRACK_MASK_INTERSECT,31,-96,16,medium_turn_right_rects+96}  ,{TRACK_MASK_DIFFERENCE,31,-96,16,medium_turn_right_rects+96}  ,{TRACK_MASK_INTERSECT,33,-128,0,medium_turn_right_rects+127},{TRACK_MASK_DIFFERENCE,33,-128,0,medium_turn_right_rects+127},
{TRACK_MASK_INTERSECT,32,0,0,medium_turn_right_rects+160},{TRACK_MASK_DIFFERENCE,32,0,0,medium_turn_right_rects+160},{TRACK_MASK_INTERSECT,32,-32,-16,medium_turn_right_rects+192},{TRACK_MASK_DIFFERENCE,32,-32,-16,medium_turn_right_rects+192},{TRACK_MASK_INTERSECT,31,0,-32,medium_turn_right_rects+224},{TRACK_MASK_DIFFERENCE,31,0,-32,medium_turn_right_rects+224},{TRACK_MASK_INTERSECT,49,-32,-48,medium_turn_right_rects+255},{TRACK_MASK_DIFFERENCE,49,-32,-48,medium_turn_right_rects+255},{TRACK_MASK_INTERSECT,33,0,-64,medium_turn_right_rects+304} ,{TRACK_MASK_DIFFERENCE,33,0,-64,medium_turn_right_rects+304},
{TRACK_MASK_INTERSECT,17,0,0,medium_turn_right_rects+337},{TRACK_MASK_DIFFERENCE,17,0,0,medium_turn_right_rects+337},{TRACK_MASK_INTERSECT,16,32,-16,medium_turn_right_rects+354} ,{TRACK_MASK_DIFFERENCE,16,32,-16,medium_turn_right_rects+354} ,{TRACK_MASK_INTERSECT,16,64,0,medium_turn_right_rects+370} ,{TRACK_MASK_DIFFERENCE,16,64,0,medium_turn_right_rects+370} ,{TRACK_MASK_INTERSECT,16,96,-16,medium_turn_right_rects+386} ,{TRACK_MASK_DIFFERENCE,16,96,-16,medium_turn_right_rects+386} ,{TRACK_MASK_INTERSECT,17,128,0,medium_turn_right_rects+402} ,{TRACK_MASK_DIFFERENCE,17,128,0,medium_turn_right_rects+402},
{TRACK_MASK_INTERSECT,32,0,0,medium_turn_right_rects+419},{TRACK_MASK_DIFFERENCE,32,0,0,medium_turn_right_rects+419},{TRACK_MASK_INTERSECT,49,32,16,medium_turn_right_rects+451}  ,{TRACK_MASK_DIFFERENCE,49,32,16,medium_turn_right_rects+451}  ,{TRACK_MASK_INTERSECT,31,0,32,medium_turn_right_rects+500} ,{TRACK_MASK_DIFFERENCE,31,0,32,medium_turn_right_rects+500} ,{TRACK_MASK_INTERSECT,32,32,48,medium_turn_right_rects+531}  ,{TRACK_MASK_DIFFERENCE,32,32,48,medium_turn_right_rects+531}  ,{TRACK_MASK_INTERSECT,33,0,64,medium_turn_right_rects+563}  ,{TRACK_MASK_DIFFERENCE,33,0,64,medium_turn_right_rects+563}
};
const track_section_t split_medium_helix_right_up={TRACK_OFFSET_SPRITE_MASK|TRACK_BANK_RIGHT|TRACK_SUPPORT_BASE|TRACK_EXIT_180_DEG,medium_helix_right_up_curve,MEDIUM_HELIX_LENGTH,{{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_masks},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_masks+10},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_masks+20},{VIEW_NEEDS_TRACK_MASK,10,split_medium_turn_right_masks+30}}};
...
const track_section_t split_vertical_booster={TRACK_VERTICAL|TRACK_NO_SUPPORTS|TRACK_SPECIAL_VERTICAL_BOOSTER,vertical_curve,VERTICAL_LENGTH,{{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,single_tile_split_masks},{VIEW_NEEDS_TRACK_MASK,2,gentle_up_to_right_bank_masks},{VIEW_NEEDS_TRACK_MASK,2,gentle_up_to_right_bank_masks+2}}};
