...
TRACK_GROUP_HALF_LOOPS=0x4000,
TRACK_GROUP_QUARTER_LOOPS=0x8000,
TRACK_GROUP_CORKSCREWS=0x10000,
...
extern track_section_t large_half_loop_left;
extern track_section_t large_half_loop_right;
