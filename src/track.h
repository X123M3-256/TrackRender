...
enum track_groups
{
    TRACK_GROUP_BRAKES = 0x1,
    TRACK_GROUP_GENTLE_SLOPES = 0x2,
    TRACK_GROUP_STEEP_SLOPES = 0x4,
    TRACK_GROUP_VERTICAL_SLOPES = 0x8,
    TRACK_GROUP_TURNS = 0x10,
    TRACK_GROUP_SLOPED_TURNS = 0x20,
    TRACK_GROUP_DIAGONALS = 0x40,
    TRACK_GROUP_BANKED_TURNS = 0x80,
    TRACK_GROUP_BANKED_SLOPED_TURNS = 0x100,
    TRACK_GROUP_S_BENDS = 0x200,
    TRACK_GROUP_HELICES = 0x400,
    TRACK_GROUP_LARGE_SLOPE_TRANSITIONS = 0x800,
    TRACK_GROUP_BARREL_ROLLS = 0x1000,
    TRACK_GROUP_HALF_LOOPS = 0x2000,
    TRACK_GROUP_QUARTER_LOOPS = 0x4000,
    TRACK_GROUP_CORKSCREWS = 0x8000,
    TRACK_GROUP_BOOSTERS = 0x10000,
    TRACK_GROUP_LAUNCHED_LIFTS = 0x20000,
    TRACK_GROUP_TURN_BANK_TRANSITIONS = 0x40000
};
...
extern track_section_t booster;
...
extern track_section_t corkscrew_right;
